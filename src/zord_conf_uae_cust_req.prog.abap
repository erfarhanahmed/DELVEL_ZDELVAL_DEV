...
INCLUDE ZORDER_CONF_UAE_CUST_REQ.
*INCLUDE ZORDER_CONF_UAE_SALES_ORD.
*INCLUDE ZORDER_CONF_UAE_ORD_CON.
...
*      EXPORT TEXT1 TO MEMORY ID 'SER'
      IMPORT TEXT1 TO WA_FINAL-TEXT1 FROM MEMORY ID 'SER'.
