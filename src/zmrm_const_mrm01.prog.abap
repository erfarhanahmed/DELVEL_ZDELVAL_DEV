...
* Herkunft eines Logistik-Rechnungsbeleges
  ...
  c_ivtyp_crm     LIKE rbkp-ivtyp VALUE 'F',  " CRM invoice
  c_ivtyp_soa_a2a LIKE rbkp-ivtyp VALUE 'G',  " SOA-A2A
  c_ivtyp_soa_b2b LIKE rbkp-ivtyp VALUE 'H',  " SOA-B2B
  c_ivtyp_ariba   LIKE rbkp-ivtyp VALUE 'I',  " Ariba invoice    "1878009
  c_ivtyp_ariba_park   LIKE rbkp-ivtyp VALUE 'J', "Ariba invoice from Parking "1968355

* Nachrichtenerzeugende Anwendung (Programm-Identifikation)
  c_ident_ers   TYPE rm08_ident VALUE 'E', " ERS mit Log-Reprü
  c_ident_is    TYPE rm08_ident VALUE 'I', " Rechnungsplan
  c_ident_neu   TYPE rm08_ident VALUE 'N', " Neubewertung mit Log-R
  c_ident_rekl  TYPE rm08_ident VALUE 'R', " Rechnungskürzung / Rekl
  c_ident_kons  TYPE rm08_ident VALUE 'K', " Konsi mit RWIN

* Steuerbehandlung bei der Rechnungskürzung (T169P-IRTAX)
...
* Rechnungsbeleg-Status
  ...
  c_rbstat_batch  LIKE rbkp-rbstat VALUE '1',  " zu prüfen im Hintergrd
  ...
  c_rbstat_comple_ch LIKE rbkp-rbstat VALUE 'F', " vollst. ändern -int.

* Invoice document prepayment status
  c_prepay_posted LIKE rbkp-prepay_status VALUE 'D',

* Rechnungsprüfungs-Art
  c_repart_online LIKE rbkp-repart VALUE space, " Online-Reprü
  c_repart_sofort LIKE rbkp-repart VALUE '1',  " Sofort-BatchReprü
  c_repart_zyklus LIKE rbkp-repart VALUE '2',  " Zyklus-BatchReprü
  c_repart_keine  LIKE rbkp-repart VALUE '3',  " keine Reprü
...
* reference types for contract reference               "EhP5 Contracts
  c_contractreferencetype_1 TYPE rm08m-contractreferencetype VALUE '1',"Both
  c_contractreferencetype_2 TYPE rm08m-contractreferencetype VALUE '2',"SRM
  c_contractreferencetype_3 TYPE rm08m-contractreferencetype VALUE '3',"ERP

* reference type for transportation management (TM)    "EhP5E TM
  c_tmreferencetype_1 TYPE erptms_s_iv_reference-tm_reference_document VALUE '1',
  c_tmreferencetype_2 TYPE erptms_s_iv_reference-tm_reference_document VALUE '2',
  c_tmreferencetype_3 TYPE erptms_s_iv_reference-tm_reference_document VALUE '3',
  c_tmreferencetype_4 TYPE erptms_s_iv_reference-tm_reference_document VALUE '4',
  c_tmreferencetype_5 TYPE erptms_s_iv_reference-tm_reference_document VALUE '5',
  c_tmreferencetype_6 TYPE erptms_s_iv_reference-tm_reference_document VALUE '6',
...
c_kzmek_unklar LIKE rbdrseg-kzmek VALUE '1',   " ungeklärter Fehler
...
c_prk_betrag LIKE rbdrseg-efkor VALUE '1',   " Betrag geändert
c_prk_kond   LIKE rbdrseg-efkor VALUE '2',   " Konditionen geändert
...
*-- Logistik-Rechnungsbeleg: Buchungsschlüssel für Kreditorenzeile
c_bslkh      LIKE accit-bschl VALUE '31',  " Buchung im Haben
c_bslks      LIKE accit-bschl VALUE '21',  " Buchung im Soll

*-- Logistik-Rechnungsbeleg: Buchungsschlüssel für Sachkontenzeile
...
* Aktivitäten in der Rechnungsprüfung
c_trtyp_a LIKE t169-trtyp VALUE 'A', "Anzeigen
c_trtyp_h LIKE t169-trtyp VALUE 'H', "Hinzufügen
c_trtyp_v LIKE t169-trtyp VALUE 'V', "Verändern
c_trtyp_d LIKE t169-trtyp VALUE 'D', "Löschen
...
*------ Übergabeparameter bei Funktionsbausteinen
...
* Differenzenbearbeitung: Einschränkung Positionsanzeige
c_verd_kein TYPE c VALUE '0',          "keine Einschränkung
c_verd_lifs TYPE c VALUE '1',          "Einschränkung nach Lieferschein
...
c_verd_ufeh TYPE c VALUE '7',          "... ungeklärte Fehler
c_aggregation TYPE c VALUE '8',        "Aggregation

* ToleranzenPrüfungsErgebnis
tolpruef_ueberb TYPE c VALUE '1',      " Überschreitung  Betragsgrenze
tolpruef_ueberp TYPE c VALUE '2',      " Überschreitung  Prozentgrenze
...
* Status der Rechnung
c_xstate_new      TYPE c VALUE '0',    " Neu - nicht geprüft
c_xstate_correc   TYPE c VALUE '1',    " korrekt geprüft
c_xstate_incorr   TYPE c VALUE '2',    " fehlerhaft geprüft
c_xstate_uncerr   TYPE c VALUE '3',    " korrekt mit ungeklärten Fehlern
...
*-------- Belegabgrenzung für ERS und Rechnungsplan ------------------*
...
c_koart_c        TYPE c              VALUE 'C',        "EhP5 Contracts
...
*--------- Invoicing transaction / Vorgang --------------------------*
c_vorgang_1      TYPE c              VALUE '1',    "Invoice
c_vorgang_2      TYPE c              VALUE '2',    "Credit Memo
*------- Transaction Key --------------------------------------------*
...
*------- Document Category ------------------------------------------*
c_doccat_invoice   TYPE document_category VALUE 'INVREC', "note 1717639
c_doccat_valuation TYPE document_category VALUE 'REVAL',  "note 1717639
c_doccat_purchase  TYPE document_category VALUE 'PURACC', "note 1717639
c_doccat_reduction TYPE document_category VALUE 'INVRED', "note 1717639
c_doccat_retention TYPE document_category VALUE 'RET',    "note 1717639
c_doccat_dpc       TYPE document_category VALUE 'DPC_MM', "note 1717639
...
*------ tabstrips ----------------------------------------------------*
gc_tabstrip_po(14) TYPE c VALUE 'ITEMS_PURCHASE',
gc_tabstrip_gl(17) TYPE c VALUE 'ITEMS_G/L_ACCOUNT',
gc_tabstrip_mat(14) TYPE c VALUE 'ITEMS_MATERIAL',
gc_tabstrip_cust(16) TYPE c VALUE 'ITEMS_CUST-LABEL',
gc_tabstrip_con(14) TYPE c VALUE 'ITEMS_CONTRACT',
gc_tabstrip_tm(12) TYPE c VALUE 'ITEMS_TM_REF',
...
**$*$-Start: MRM_CONST_MRM_01--------------------------------------------------------------------$*$*
*ENHANCEMENT 1  ISAUTO_MRM_MRM_CONST_MRM.    "active version
CONSTANTS:
c_lfehl_hsc  LIKE rseg-lfehl VALUE '9'.   "Handling Surcharge


*ENDENHANCEMENT.
*$*$-End:   MRM_CONST_MRM_01--------------------------------------------------------------------$*$*
*---------------------------------------------------------------------*
*         References                                                  *
*---------------------------------------------------------------------*
