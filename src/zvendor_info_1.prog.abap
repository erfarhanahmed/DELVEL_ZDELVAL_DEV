...
*-paresh workbench-------------------------------------------------------------------*
  ...
  PERFORM t_fieldcatlog USING '28'   'INF_TXT'   'LT_FINAL'      'Info Text'.                      "##NO_TEXT.
  PERFORM t_fieldcatlog USING '29'   'INF_NOTE'  'LT_FINAL'      'Info Record Note'.                      "##NO_TEXT.
  PERFORM t_fieldcatlog USING '30'   'URZZT'     'LT_FINAL'      'Component Weight Column'.
  PERFORM t_fieldcatlog USING '30'   'WAERS'     'LT_FINAL'      'Currency Key'.
*-------------------------------------------------------------------------------------*
ENDFORM.
*&---------------------------------------------------------------------*
*&      Form  DIS_LAYOUT
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  ...
  IF sy-subrc = 0.
DATA lv_string_886 TYPE string.
DATA lv_crlf_886 TYPE string.
lv_crlf_886 = cl_abap_char_utilities=>cr_lf.
lv_string_886 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_886 lv_crlf_886 wa_csv INTO lv_string_886.
  CLEAR: wa_csv.
ENDLOOP.
*TRANSFER lv_string_1507 TO lv_fullfile.
TRANSFER lv_string_886 TO lv_fullfile.
