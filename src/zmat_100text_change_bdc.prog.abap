...
REPORT ZMAT_100TEXT_CHANGE_BDC NO STANDARD PAGE HEADING LINE-SIZE 255.
...
TYPES : BEGIN OF t_file ,
          ...
          maktx       TYPE char200,   "9 Material Description (Short Text)
...
AT SELECTION-SCREEN.
  ...
  IF sscrfields-ucomm EQ 'BUT1' .
    SUBMIT  ZMAT_100TEXT_CHANGE_BDC_EXL VIA SELECTION-SCREEN .
  ENDIF.
*>>
...
*  w_longtext-langu = 'ES'.
  ...
  w_longtext-text_line =  wa_file-maktx+0(132).
...
*     NFMSTRUCTURALWEIGHTSX       =
  ...
  ELSE.
    ...
    EXPORT wa_file-matnr  TO MEMORY ID 'zmat' .
    ENDIF.
