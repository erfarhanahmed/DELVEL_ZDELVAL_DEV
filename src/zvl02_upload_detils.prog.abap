*&---------------------------------------------------------------------*
*& Module Pool       ZVL02_UPLOAD_DETILS
*&
*&---------------------------------------------------------------------*
*&
*&
...
INCLUDE ZVL02_UPLOAD_DETAILS_TOP                .    " global Data

 INCLUDE ZVL02_UPLOAD_DETAILS_O01                .  " PBO-Modules
 INCLUDE ZVL02_UPLOAD_DETAILS_I01                .  " PAI-Modules
* INCLUDE ZVL02_UPLOAD_DETAILS_F01                .  " FORM-Routines
...
MODULE TC1_CHANGE_TC_ATTR OUTPUT.
  DESCRIBE TABLE LT_FINAL LINES TC1-lines.
ENDMODULE.
...
MODULE TC1_MARK INPUT.
  DATA: g_TC1_wa2 like line of LT_FINAL.
    if TC1-line_sel_mode = 1
    and LS_FINAL-MARK = 'X'.
     loop at LT_FINAL into g_TC1_wa2
       where MARK = 'X'.
       g_TC1_wa2-MARK = ' '.
       modify LT_FINAL
         from g_TC1_wa2
  ...
  MODIFY LT_FINAL
   ...
   s_mark = LS_FINAL-MARK.
    IF LS_FINAL-mark = 'X'.
        s_VHILM_KU   =  LS_FINAL-VHILM_KU.
        BOX_NO       = s_VHILM_KU.
        LS_FINAL-mark = ' '.
    ENDIF.
...
CONTROLS: TC2 TYPE TABLEVIEW USING SCREEN 2000.
...
MODULE TC2_CHANGE_TC_ATTR OUTPUT.
  DESCRIBE TABLE LT_FINAL1 LINES TC2-lines.
ENDMODULE.
...
MODULE TC2_MODIFY INPUT.
  ...
  IF ls_final1-ZLMAT is NOT INITIAL .
  ls_final2-VHILM_KU = BOX_NO.
  ls_final2-vbeln = s_vbeln.  "
  ls_final2-ZLMAT = ls_final1-ZLMAT.
  ls_final2-ZMATQN = ls_final1-ZMATQN.
  APPEND ls_final2 to lt_final2. "
  APPEND ls_final1 to lt_final1.

*  MODIFY ZMATQUAN FROM ls_final2.
*   APPEND ZMATQUAN TO lT_final2.
  CLEAR ls_final2.
  CLEAR LS_FINAL-MARK.
  ENDIF.


*  INSERT ZMATQUAN FROM ls_final1.
*  INSERT ZMATQUAN INTO lt_final2.
*  MOVE-CORRESPONDING lt_final2 TO ZMATQUAN.
ENDMODULE.
