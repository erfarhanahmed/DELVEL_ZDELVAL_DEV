*&---------------------------------------------------------------------*
*&Report: ZSU_SO_DELIVERY_ANALYSIS_1
*&Transaction: ZSU_DEL_PERFORM_1
*&Functional Cosultant: Tejaswini Kapdnis
...
PARAMETERS     : p_vkorg TYPE vbak-vkorg OBLIGATORY DEFAULT 'SU00' MODIF ID BU.
...
PARAMETERS p_folder LIKE rlgrap-filename DEFAULT 'E:\delval\Saudi'.
...
FORM get_fcat .
  PERFORM fcat USING : '1'   'VBELN'           'IT_FINAL'      'Sale Order No'                 '20' ,
                      ...
                      '10'   'BUDAT'           'IT_FINAL'      'FG Credit date @SUTP Store'              '15' ,
...
* Implement suitable error handling here
  ...
  lv_file = 'ZSU_DEL_PERFORM_1.TXT'.

  CONCATENATE p_folder '\' lv_file
  INTO lv_fullfile.
* BREAK primus.
  WRITE: / 'ZSU_DEL_PERFORM_1 Download started on', sy-datum, 'at', sy-uzeit.
