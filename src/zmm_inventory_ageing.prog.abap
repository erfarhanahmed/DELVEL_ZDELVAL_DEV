...
REPORT  zmm_inventory_ageing MESSAGE-ID zdel.
...
TYPES : BEGIN OF t_mara,
       ...
       END OF t_qamb,
        ...
        BEGIN OF t_result,
          ...
          urq_bt181_210   TYPE zurq_bt181_210,
          v_urq_bt181_210 TYPE zv_urq_bt181_210,
          soq_bt181_210   TYPE zsoq_bt181_210,
          v_soq_bt181_210 TYPE zv_soq_bt181_210,

          urq_bt211_240   TYPE zurq_bt211_240,
          v_urq_bt211_240 TYPE zv_urq_bt211_240,
          soq_bt211_240   TYPE zsoq_bt211_240,
          v_soq_bt211_240 TYPE zv_soq_bt211_240,

          urq_bt241_270   TYPE zurq_bt241_270,
          v_urq_bt241_270 TYPE zv_urq_bt241_270,
          soq_bt241_270   TYPE zsoq_bt241_270,
          v_soq_bt241_270 TYPE zv_soq_bt241_270,

          urq_bt271_300   TYPE zurq_bt271_300,
          v_urq_bt271_300 TYPE zv_urq_bt271_300,
          soq_bt271_300   TYPE zsoq_bt271_300,
          v_soq_bt271_300 TYPE zv_soq_bt271_300,

          urq_bt301_330   TYPE zurq_bt301_330,
          v_urq_bt301_330 TYPE zv_urq_bt301_330,
          soq_bt301_330   TYPE zsoq_bt301_330,
          v_soq_bt301_330 TYPE zv_soq_bt301_330,

          urq_bt331_360   TYPE zurq_bt331_360,
          v_urq_bt331_360 TYPE zv_urq_bt331_360,
          soq_bt331_360   TYPE zsoq_bt331_360,
          v_soq_bt331_360 TYPE zv_soq_bt331_360,

          urq_gt360       TYPE zurq_gt360,
          v_urq_gt360     TYPE zv_urq_gt360,
          soq_gt360       TYPE zsoq_gt360,
          v_soq_gt360     TYPE zv_soq_gt360,
...
*          v_soq_gt180     TYPE zv_soq_gt180,
        ...
        BEGIN OF t_rslt,
          ...
          q_bt181_210   TYPE zurq_bt181_210,

          q_bt211_240   TYPE zurq_bt211_240,
          q_bt241_270   TYPE zurq_bt241_270,
          q_bt271_300   TYPE zurq_bt271_300,
          q_bt301_330   TYPE zurq_bt301_330,
          q_bt331_360   TYPE zurq_bt331_360,
          q_gt360       TYPE zurq_gt360,
          ...
          v_q_bt181_210 TYPE zv_urq_bt181_210,
          v_q_bt211_240 TYPE zv_urq_bt211_240,
          v_q_bt241_270 TYPE zv_urq_bt241_270,
          v_q_bt271_300 TYPE zv_urq_bt271_300,
          v_q_bt301_330 TYPE zv_urq_bt301_330,
          v_q_bt331_360 TYPE zv_urq_bt331_360,
          v_q_gt360     TYPE zv_urq_gt360,
...
TYPES: BEGIN OF ty_final,
          ...
          urq_bt181_210   TYPE char50,
          v_urq_bt181_210 TYPE char50,
          soq_bt181_210   TYPE char50,
          v_soq_bt181_210 TYPE char50,

          urq_bt211_240   TYPE char50,
          v_urq_bt211_240 TYPE char50,
          soq_bt211_240   TYPE char50,
          v_soq_bt211_240 TYPE char50,

          urq_bt241_270   TYPE char50,
          v_urq_bt241_270 TYPE char50,
          soq_bt241_270   TYPE char50,
          v_soq_bt241_270 TYPE char50,

          urq_bt271_300   TYPE char50,
          v_urq_bt271_300 TYPE char50,
          soq_bt271_300   TYPE char50,
          v_soq_bt271_300 TYPE char50,

          urq_bt301_330   TYPE char50,
          v_urq_bt301_330 TYPE char50,
          soq_bt301_330   TYPE char50,
          v_soq_bt301_330 TYPE char50,

          urq_bt331_360   TYPE char50,
          v_urq_bt331_360 TYPE char50,
          soq_bt331_360   TYPE char50,
          v_soq_bt331_360 TYPE char50,

          urq_gt360       TYPE char50,
          v_urq_gt360     TYPE char50,
          soq_gt360       TYPE char50,
          v_soq_gt360     TYPE char50,
...
*          v_soq_gt180     TYPE char50,
          ...
          ur_totqty       TYPE char50, " UNRESTRICTED STOCK : TOTAL QUANTITY
          ur_totval       TYPE char50,   " UNRESTRICTED STOCK : TOTAL VALUE
          so_totqty       TYPE char50, " SALES ORDER STOCK : TOTAL QUANTITY
          so_totval       TYPE char50,   " SALES ORDER STOCK : TOTAL VALUE
    ...
    LOOP AT it_mara INTO wa_mara.
      ...
      LOOP AT it_mard INTO wa_mard WHERE matnr = wa_mara-matnr .        "AND ( labst IS NOT INITIAL or insme IS NOT INITIAL ).
        ...
        IF NOT w_rslt IS INITIAL.
          ...
          wa_rslt-urq_bt181_210 = w_rslt-q_bt181_210.

          wa_rslt-urq_bt211_240 = w_rslt-q_bt211_240.
          wa_rslt-urq_bt241_270 = w_rslt-q_bt241_270.
          wa_rslt-urq_bt271_300 = w_rslt-q_bt271_300.
          wa_rslt-urq_bt301_330 = w_rslt-q_bt301_330.
          wa_rslt-urq_bt331_360 = w_rslt-q_bt331_360.

          wa_rslt-urq_gt360     = w_rslt-q_gt360.
*          wa_rslt-urq_gt180     = w_rslt-q_gt180.
          ...
          wa_rslt-v_urq_bt181_210  = zrate * wa_rslt-urq_bt181_210.

          wa_rslt-v_urq_bt211_240  = zrate * wa_rslt-urq_bt211_240.
          wa_rslt-v_urq_bt241_270  = zrate * wa_rslt-urq_bt241_270.
          wa_rslt-v_urq_bt271_300  = zrate * wa_rslt-urq_bt271_300.
          wa_rslt-v_urq_bt301_330  = zrate * wa_rslt-urq_bt301_330.
          wa_rslt-v_urq_bt331_360  = zrate * wa_rslt-urq_bt331_360.

          wa_rslt-v_urq_gt360      = zrate * wa_rslt-urq_gt360    .
*          wa_rslt-v_urq_gt180      = zrate * wa_rslt-urq_gt180    .
        ...
        IF NOT w_rslt IS INITIAL.
          ...
          wa_rslt-soq_bt181_210    = w_rslt-q_bt181_210.

          wa_rslt-soq_bt211_240    = w_rslt-q_bt211_240.
          wa_rslt-soq_bt241_270    = w_rslt-q_bt241_270.
          wa_rslt-soq_bt271_300    = w_rslt-q_bt271_300.
          wa_rslt-soq_bt301_330    = w_rslt-q_bt301_330.
          wa_rslt-soq_bt331_360    = w_rslt-q_bt331_360.
          wa_rslt-soq_gt360        = w_rslt-q_gt360.
*          wa_rslt-soq_gt180        = w_rslt-q_gt180.
          ...
          wa_rslt-v_soq_bt181_210  = zrate * wa_rslt-soq_bt181_210.

          wa_rslt-v_soq_bt211_240  = zrate * wa_rslt-soq_bt211_240.
          wa_rslt-v_soq_bt241_270  = zrate * wa_rslt-soq_bt241_270.
          wa_rslt-v_soq_bt271_300  = zrate * wa_rslt-soq_bt271_300.
          wa_rslt-v_soq_bt301_330  = zrate * wa_rslt-soq_bt301_330.
          wa_rslt-v_soq_bt331_360  = zrate * wa_rslt-soq_bt331_360.
          wa_rslt-v_soq_gt360      = zrate * wa_rslt-soq_gt360    .
...
********************************* Download File Data*******************************************************
        ...
        wa_final-urq_bt181_210 =    wa_rslt-urq_bt181_210 .
        wa_final-urq_bt211_240 =    wa_rslt-urq_bt211_240 .
        wa_final-urq_bt241_270 =    wa_rslt-urq_bt241_270 .
        wa_final-urq_bt271_300 =    wa_rslt-urq_bt271_300 .
        wa_final-urq_bt301_330 =    wa_rslt-urq_bt301_330 .
        wa_final-urq_bt331_360 =    wa_rslt-urq_bt331_360 .

        wa_final-urq_gt360     =    wa_rslt-urq_gt360     .
*        wa_final-urq_gt180     =    wa_rslt-urq_gt180     .
        ...
        wa_final-v_urq_bt181_210 =   wa_rslt-v_urq_bt181_210 .
        wa_final-v_urq_bt211_240 =   wa_rslt-v_urq_bt211_240 .
        wa_final-v_urq_bt241_270 =   wa_rslt-v_urq_bt241_270 .
        wa_final-v_urq_bt271_300 =   wa_rslt-v_urq_bt271_300 .
        wa_final-v_urq_bt301_330 =   wa_rslt-v_urq_bt301_330 .
        wa_final-v_urq_bt331_360 =   wa_rslt-v_urq_bt331_360 .

        wa_final-v_urq_gt360     =   wa_rslt-v_urq_gt360     .
*        wa_final-v_urq_gt180     =   wa_rslt-v_urq_gt180     .
        ...
        wa_final-soq_bt181_210    =   wa_rslt-soq_bt181_210    .
        wa_final-soq_bt211_240    =   wa_rslt-soq_bt211_240    .
        wa_final-soq_bt241_270    =   wa_rslt-soq_bt241_270    .
        wa_final-soq_bt271_300    =   wa_rslt-soq_bt271_300    .
        wa_final-soq_bt301_330    =   wa_rslt-soq_bt301_330    .
        wa_final-soq_bt331_360    =   wa_rslt-soq_bt331_360    .

        wa_final-soq_gt360        =   wa_rslt-soq_gt360        .
*        wa_final-soq_gt180        =   wa_rslt-soq_gt180        .
        ...
        wa_final-v_soq_bt181_210    =   wa_rslt-v_soq_bt181_210 .
        wa_final-v_soq_bt211_240    =   wa_rslt-v_soq_bt211_240 .
        wa_final-v_soq_bt241_270    =   wa_rslt-v_soq_bt241_270 .
        wa_final-v_soq_bt271_300    =   wa_rslt-v_soq_bt271_300 .
        wa_final-v_soq_bt301_330    =   wa_rslt-v_soq_bt301_330 .
        wa_final-v_soq_bt331_360    =   wa_rslt-v_soq_bt331_360 .
        wa_final-v_soq_gt360        =   wa_rslt-v_soq_gt360     .
...
***********************************************************************************************************************
        ...
        CLEAR : WA_RSLT-URQ_LT30,WA_RSLT-V_URQ_LT30,WA_RSLT-SOQ_LT30,WA_RSLT-V_SOQ_LT30,WA_RSLT-URQ_BT31_60,WA_RSLT-V_URQ_BT31_60,WA_RSLT-SOQ_BT31_60,
          ...
          WA_RSLT-V_URQ_BT151_180,WA_RSLT-SOQ_BT151_180,WA_RSLT-V_SOQ_BT151_180,WA_RSLT-UR_TOTQTY,WA_RSLT-UR_TOTVAL,WA_RSLT-SO_TOTQTY,
          WA_RSLT-SO_TOTVAL.

        CLEAR : WA_RSLT-SOQ_BT181_210,WA_RSLT-V_URQ_BT181_210,WA_RSLT-SOQ_BT181_210,WA_RSLT-V_SOQ_BT181_210.
        CLEAR : WA_RSLT-SOQ_BT211_240,WA_RSLT-V_URQ_BT211_240,WA_RSLT-SOQ_BT211_240,WA_RSLT-V_SOQ_BT211_240.
        CLEAR : WA_RSLT-SOQ_BT241_270,WA_RSLT-V_URQ_BT241_270,WA_RSLT-SOQ_BT241_270,WA_RSLT-V_SOQ_BT241_270.
        CLEAR : WA_RSLT-SOQ_BT271_300,WA_RSLT-V_URQ_BT271_300,WA_RSLT-SOQ_BT271_300,WA_RSLT-V_SOQ_BT271_300.
        CLEAR : WA_RSLT-SOQ_BT301_330,WA_RSLT-V_URQ_BT301_330,WA_RSLT-SOQ_BT301_330,WA_RSLT-V_SOQ_BT301_330.
        CLEAR : WA_RSLT-SOQ_BT331_360,WA_RSLT-V_URQ_BT331_360,WA_RSLT-SOQ_BT331_360,WA_RSLT-V_SOQ_BT331_360.
        CLEAR : WA_RSLT-URQ_GT360,WA_RSLT-V_URQ_GT360,WA_RSLT-SOQ_GT360,WA_RSLT-V_SOQ_GT360.
...
*           V2 TYPE CHAR5,
  ...
  IF stktyp = 'UR'.
*    str = 'BWART IN (101,561,309,311,411,412,501,531,653,701,321,Z11) AND MATNR = P_MATNR '.
    str = 'BWART IN (101,561,309,311,411,412,501,531,653,701,Z11) AND MATNR = P_MATNR '.
  ...
  SELECT mblnr
    ...
    FROM mseg
    INTO TABLE it_mseg
    WHERE BWART IN ('101','561','309','311','411','412','501','531','653','701','Z11','542','262',
...
*          IF sy-subrc = 0.
            ...
            ELSEIF dspan BETWEEN 181 AND 210.
              w_rslt-q_bt181_210  = wa_mseg-menge + w_rslt-q_bt181_210.
            ELSEIF dspan BETWEEN 211 AND 240.
              w_rslt-q_bt211_240  = wa_mseg-menge + w_rslt-q_bt211_240.
            ELSEIF dspan BETWEEN 241 AND 270.
              w_rslt-q_bt241_270  = wa_mseg-menge + w_rslt-q_bt241_270.
            ELSEIF dspan BETWEEN 271 AND 300.
              w_rslt-q_bt271_300  = wa_mseg-menge + w_rslt-q_bt271_300.
            ELSEIF dspan BETWEEN 301 AND 330.
              w_rslt-q_bt301_330  = wa_mseg-menge + w_rslt-q_bt301_330.
            ELSEIF dspan BETWEEN 331 AND 360.
              w_rslt-q_bt331_360  = wa_mseg-menge + w_rslt-q_bt331_360.
            ELSE.
              w_rslt-q_gt180      = wa_mseg-menge + w_rslt-q_gt180.
              w_rslt-q_gt360      = wa_mseg-menge + w_rslt-q_gt360.
            ENDIF.
...
*      VAR_I = VAR_I + 1.
    ...
    o_color-int = 1.
    o_color-inv = 0.
    l_column ?= l_columns->get_column( 'URQ_BT181_210' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'V_URQ_BT181_210' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'SOQ_BT181_210' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'V_SOQ_BT181_210' ).
    l_column->set_color( o_color ).
    ...
    o_color-int = 0.
    o_color-inv = 0.
    l_column ?= l_columns->get_column( 'URQ_BT211_240' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'V_URQ_BT211_240' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'SOQ_BT211_240' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'V_SOQ_BT211_240' ).
    l_column->set_color( o_color ).
    ...
    o_color-int = 1.
    o_color-inv = 0.
    l_column ?= l_columns->get_column( 'URQ_BT241_270' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'V_URQ_BT241_270' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'SOQ_BT241_270' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'V_SOQ_BT241_270' ).
    l_column->set_color( o_color ).
    ...
    o_color-int = 0.
    o_color-inv = 0.
    l_column ?= l_columns->get_column( 'URQ_BT271_300' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'V_URQ_BT271_300' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'SOQ_BT271_300' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'V_SOQ_BT271_300' ).
    l_column->set_color( o_color ).
    ...
    o_color-int = 1.
    o_color-inv = 0.
    l_column ?= l_columns->get_column( 'URQ_BT301_330' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'V_URQ_BT301_330' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'SOQ_BT301_330' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'V_SOQ_BT301_330' ).
    l_column->set_color( o_color ).
    ...
    o_color-int = 0.
    o_color-inv = 0.
    l_column ?= l_columns->get_column( 'URQ_BT331_360' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'V_URQ_BT331_360' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'SOQ_BT331_360' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'V_SOQ_BT331_360' ).
    l_column->set_color( o_color ).
    ...
    o_color-int = 0.
    o_color-inv = 0.
    l_column ?= l_columns->get_column( 'URQ_GT360' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'V_URQ_GT360' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'SOQ_GT360' ).
    l_column->set_color( o_color ).
    CLEAR : l_column.
    l_column ?= l_columns->get_column( 'V_SOQ_GT360' ).
    l_column->set_color( o_color ).
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  lv_file = 'ZMATLINVAGRM01.TXT'.

  CONCATENATE p_folder '\' lv_file
    INTO lv_fullfile.
  WRITE: / 'ZMATLINVAGRM01 Download started on', sy-datum, 'at', sy-uzeit.
  OPEN DATASET lv_fullfile
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_1642 TYPE string.
DATA lv_crlf_1642 TYPE string.
lv_crlf_1642 = cl_abap_char_utilities=>cr_lf.
lv_string_1642 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1642 lv_crlf_1642 wa_csv INTO lv_string_1642.
  CLEAR: wa_csv.
ENDLOOP.
TRANSFER lv_string_1642 TO lv_fullfile.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  lv_file = 'ZMATLINVAGFG01.TXT'.

  CONCATENATE p_folder '\' lv_file
    INTO lv_fullfile.
  WRITE: / 'ZMATLINVAGFG01 Download started on', sy-datum, 'at', sy-uzeit.
  OPEN DATASET lv_fullfile
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_1677 TYPE string.
DATA lv_crlf_1677 TYPE string.
lv_crlf_1677 = cl_abap_char_utilities=>cr_lf.
lv_string_1677 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1677 lv_crlf_1677 wa_csv INTO lv_string_1677.
  CLEAR: wa_csv.
ENDLOOP.
TRANSFER lv_string_1677 TO lv_fullfile.
    CONCATENATE 'File' lv_fullfile 'downloaded' INTO lv_msg SEPARATED BY space.
    MESSAGE lv_msg TYPE 'S'.
  ENDIF.
ENDIF.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  lv_file = 'ZMATLINVAGTPI1.TXT'.

  CONCATENATE p_folder '\' lv_file
    INTO lv_fullfile.
  WRITE: / 'ZMATLINVAGTPI1 Download started on', sy-datum, 'at', sy-uzeit.
  OPEN DATASET lv_fullfile
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_1712 TYPE string.
DATA lv_crlf_1712 TYPE string.
lv_crlf_1712 = cl_abap_char_utilities=>cr_lf.
lv_string_1712 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1712 lv_crlf_1712 wa_csv INTO lv_string_1712.
  CLEAR: wa_csv.
ENDLOOP.
TRANSFER lv_string_1712 TO lv_fullfile.
    CONCATENATE 'File' lv_fullfile 'downloaded' INTO lv_msg SEPARATED BY space.
    MESSAGE lv_msg TYPE 'S'.
  ENDIF.
ENDIF.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  lv_file = 'ZMATLINVAGRJ01.TXT'.

  CONCATENATE p_folder '\' lv_file
    INTO lv_fullfile.
  WRITE: / 'ZMATLINVAGRJ01 Download started on', sy-datum, 'at', sy-uzeit.
  OPEN DATASET lv_fullfile
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_1747 TYPE string.
DATA lv_crlf_1747 TYPE string.
lv_crlf_1747 = cl_abap_char_utilities=>cr_lf.
lv_string_1747 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1747 lv_crlf_1747 wa_csv INTO lv_string_1747.
  CLEAR: wa_csv.
ENDLOOP.
TRANSFER lv_string_1747 TO lv_fullfile.
    CONCATENATE 'File' lv_fullfile 'downloaded' INTO lv_msg SEPARATED BY space.
    MESSAGE lv_msg TYPE 'S'.
  ENDIF.
ENDIF.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  lv_file = 'ZMATLINVAGRWK1.TXT'.

  CONCATENATE p_folder '\' lv_file
    INTO lv_fullfile.
  WRITE: / 'ZMATLINVAGRWK1 Download started on', sy-datum, 'at', sy-uzeit.
  OPEN DATASET lv_fullfile
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_1782 TYPE string.
DATA lv_crlf_1782 TYPE string.
lv_crlf_1782 = cl_abap_char_utilities=>cr_lf.
lv_string_1782 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1782 lv_crlf_1782 wa_csv INTO lv_string_1782.
  CLEAR: wa_csv.
ENDLOOP.
TRANSFER lv_string_1782 TO lv_fullfile.
    CONCATENATE 'File' lv_fullfile 'downloaded' INTO lv_msg SEPARATED BY space.
    MESSAGE lv_msg TYPE 'S'.
  ENDIF.
ENDIF.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  lv_file = 'ZMATLINVAGSCR1.TXT'.

  CONCATENATE p_folder '\' lv_file
    INTO lv_fullfile.
  WRITE: / 'ZMATLINVAGSCR1 Download started on', sy-datum, 'at', sy-uzeit.
  OPEN DATASET lv_fullfile
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_1817 TYPE string.
DATA lv_crlf_1817 TYPE string.
lv_crlf_1817 = cl_abap_char_utilities=>cr_lf.
lv_string_1817 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1817 lv_crlf_1817 wa_csv INTO lv_string_1817.
  CLEAR: wa_csv.
ENDLOOP.
TRANSFER lv_string_1817 TO lv_fullfile.
    CONCATENATE 'File' lv_fullfile 'downloaded' INTO lv_msg SEPARATED BY space.
    MESSAGE lv_msg TYPE 'S'.
  ENDIF.
ENDIF.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  lv_file = 'ZMATLINVAGSFG1.TXT'.

  CONCATENATE p_folder '\' lv_file
    INTO lv_fullfile.
  WRITE: / 'ZMATLINVAGSFG1 Download started on', sy-datum, 'at', sy-uzeit.
  OPEN DATASET lv_fullfile
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_1852 TYPE string.
DATA lv_crlf_1852 TYPE string.
lv_crlf_1852 = cl_abap_char_utilities=>cr_lf.
lv_string_1852 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1852 lv_crlf_1852 wa_csv INTO lv_string_1852.
  CLEAR: wa_csv.
ENDLOOP.
TRANSFER lv_string_1852 TO lv_fullfile.
    CONCATENATE 'File' lv_fullfile 'downloaded' INTO lv_msg SEPARATED BY space.
    MESSAGE lv_msg TYPE 'S'.
  ENDIF.
ENDIF.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  lv_file = 'ZMATLINVAGVLD1.TXT'.

  CONCATENATE p_folder '\' lv_file
    INTO lv_fullfile.
  WRITE: / 'ZMATLINVAGVLD1 Download started on', sy-datum, 'at', sy-uzeit.
  OPEN DATASET lv_fullfile
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  lv_file = 'ZMATLINVAGSRN1.TXT'.

  CONCATENATE p_folder '\' lv_file
    INTO lv_fullfile.
  WRITE: / 'ZMATLINVAGSRN1 Download started on', sy-datum, 'at', sy-uzeit.
  OPEN DATASET lv_fullfile
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_1922 TYPE string.
DATA lv_crlf_1922 TYPE string.
lv_crlf_1922 = cl_abap_char_utilities=>cr_lf.
lv_string_1922 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1922 lv_crlf_1922 wa_csv INTO lv_string_1922.
  CLEAR: wa_csv.
ENDLOOP.
...
DATA: l_field_seperator.
  ...
  CONCATENATE 'Material'
              ...
              'Unrestricted Stc(181-210 Days)'
              'UR Stc. Value (181-210 Days)'
              'Sales Ordr Stc. (181-210 Days)'
              'SO Stc. Value (181-210 Days)'

              'Unrestricted Stc(211_240 Days)'
              'UR Stc. Value (211_240 Days)'
              'Sales Ordr Stc. (211_240 Days)'
              'SO Stc. Value (211_240 Days)'

              'Unrestricted Stc(241_270 Days)'
              'UR Stc. Value (241_270 Days)'
              'Sales Ordr Stc. (241_270 Days)'
              'SO Stc. Value (241_270 Days)'

              'Unrestricted Stc(271_300 Days)'
              'UR Stc. Value (271_300 Days)'
              'Sales Ordr Stc. (271_300 Days)'
              'SO Stc. Value (271_300 Days)'

              'Unrestricted Stc(301_330 Days)'
              'UR Stc. Value (301_330 Days)'
              'Sales Ordr Stc. (301_330 Days)'
              'SO Stc. Value (301_330 Days)'

              'Unrestricted Stc(331_360 Days)'
              'UR Stc. Value (331_360 Days)'
              'Sales Ordr Stc. (331_360 Days)'
              'SO Stc. Value (331_360 Days)'

              'Unrestricted Stc ( >360 Days)'
              'UR Stc. Value ( >360Days)'
              'Sales Ordr Stc. ( >360 Days)'
              'SO Stc. Value ( >360 Days)'
              'UR Total Quantity'
              'UR Total Value'
              'SO Total Quantity'
              'SO Total Value'
