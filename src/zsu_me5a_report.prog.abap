*&---------------------------------------------------------------------*
*&Report: ZSU_ME5A_REPORT
*&Transaction: ZSU_ME5A
...
PARAMETERS     : p_plant TYPE eban-werks default 'SU01'.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  lv_file = 'ZSU_ME5A.TXT'.

*  CONCATENATE p_folder '\' lv_file
  CONCATENATE p_folder '/' lv_file
  INTO lv_fullfile.
  BREAK primus.
  WRITE: / 'ZSU_ME5A Download started on', sy-datum, 'at', sy-uzeit.
  OPEN DATASET lv_fullfile
  FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_560 TYPE string.
DATA lv_crlf_560 TYPE string.
lv_crlf_560 = cl_abap_char_utilities=>cr_lf.
lv_string_560 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_560 lv_crlf_560 wa_csv INTO lv_string_560.
  CLEAR: wa_csv.
ENDLOOP.
TRANSFER lv_string_560 TO lv_fullfile.
