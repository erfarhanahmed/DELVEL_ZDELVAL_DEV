...
*               WHERE MATNR = alv_stb1-dobjt+0(18)"IN P_MATNR
               WHERE MATNR = alv_stb1-dobjt "IN P_MATNR
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  ...
  IF sy-subrc = 0.
DATA lv_string_1294 TYPE string.
DATA lv_crlf_1294 TYPE string.
lv_crlf_1294 = cl_abap_char_utilities=>cr_lf.
lv_string_1294 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1294 lv_crlf_1294 wa_csv INTO lv_string_1294.
  CLEAR: wa_csv.
ENDLOOP.
*TRANSFER lv_string_565 TO lv_fullfile.
TRANSFER lv_string_1294 TO lv_fullfile.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  ...
  OPEN DATASET lv_fullfile
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_1332 TYPE string.
DATA lv_crlf_1332 TYPE string.
lv_crlf_1332 = cl_abap_char_utilities=>cr_lf.
lv_string_1332 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1332 lv_crlf_1332 wa_csv INTO lv_string_1332.
  CLEAR: wa_csv.
ENDLOOP.
*TRANSFER lv_string_565 TO lv_fullfile.
