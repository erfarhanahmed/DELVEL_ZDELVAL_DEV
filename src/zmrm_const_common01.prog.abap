...
* Herkunft fuer Meldungsprotokoll
  ...
  c_source_cont_assign TYPE c       VALUE 'K',   " Assign Contracts EhP5
  c_source_tm_assign TYPE c         VALUE 'T',     " Assign TMS Intergration EhP5e TM
  c_source_price  TYPE c            VALUE 'D',   " Contract EhP 5 - Price
  c_source_pricing TYPE c           VALUE 'E',   " Pricing (EhP6 DInv, CPE repricing) N1660436
  c_source_badi_dinv TYPE c         VALUE 'B',   " Differential Invoicing - EhP6 DInv - BAdI Check
  c_source_check  TYPE c            VALUE ' ',   " Check
  c_source_cond   TYPE c            VALUE 'C',   " Conditions
  c_source_soa    TYPE c            VALUE 'S',   " SOA
...
* Transaktionscodes (TCODE_*)
  ...
  tcode_mir6      LIKE sy-tcode     VALUE 'MIR6',  " Übersicht
  tcode_mir7      LIKE sy-tcode     VALUE 'MIR7',  " Vorerfassung
  tcode_mr1b      LIKE sy-tcode     VALUE 'MR1B',  " Übersicht alt
  tcode_mr1g      LIKE sy-tcode     VALUE 'MR1G',  " Gutschrifterfassung
  tcode_mr1m      LIKE sy-tcode     VALUE 'MR1M',  " Rechnungserfassung
  tcode_mr2m      LIKE sy-tcode     VALUE 'MR2M',  " Ändern
  tcode_mr3m      LIKE sy-tcode     VALUE 'MR3M',  " Anzeigen
  tcode_mr5m      LIKE sy-tcode     VALUE 'MR5M',  " Löschen
  tcode_mr8m      LIKE sy-tcode     VALUE 'MR8M',  " Stornieren
  tcode_mrrl      LIKE sy-tcode     VALUE 'MRRL',  " Log-Reprü: ERS
  tcode_mris      LIKE sy-tcode     VALUE 'MRIS',  " Log-Reprü: RePlan
...
* Aktivitätstyp
  c_actvt_create  TYPE activ_auth   VALUE '01',     " Hinzufügen
  c_actvt_change  TYPE activ_auth   VALUE '02',     " Ändern
...
* Meldungen: MessageID
  c_msgid_m8      LIKE sy-msgid VALUE 'M8',  "Rechnungsprüfung
...
* Meldungen: passende Ikonen
  c_icon_hint(30)    TYPE c     VALUE '@5B@',  " Grüner Kreis
