...
REPORT zsd_saudi_tax_invoice.

* declaration of data
INCLUDE zsaudi_invoice_data_declare.
*INCLUDE rlb_invoice_data_declare.
* definition of forms
INCLUDE zsaudi_rlb_invoice_form01.
*INCLUDE rlb_invoice_form01.
INCLUDE zsaudi_rlb_print_forms.
...
*      lv_control_params TYPE sfpcontrol,
  ...
  CONSTANTS : sf_name1 TYPE fpname VALUE 'ZTAX_INVOICE_DUB_FORM_SFP'.
...
LV_CNT = LV_CNT + 1.
    ...
    CALL FUNCTION e_funcnm "'/1BCDWB/SM00000075'
      EXPORTING
*       /1BCDWB/DOCPARAMS        =
            lv_count    = LV_CNT
*       ARCHIVE_INDEX_TAB        =
