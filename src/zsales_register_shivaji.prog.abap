...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  ...
  OPEN DATASET lv_fullfile
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_3691 TYPE string.
DATA lv_crlf_3691 TYPE string.
lv_crlf_3691 = cl_abap_char_utilities=>cr_lf.
lv_string_3691 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_3691 lv_crlf_3691 wa_csv INTO lv_string_3691.
  CLEAR: wa_csv.
ENDLOOP.
TRANSFER lv_string_3691 TO lv_fullfile.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  ...
  OPEN DATASET lv_fullfile
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_3728 TYPE string.
DATA lv_crlf_3728 TYPE string.
lv_crlf_3728 = cl_abap_char_utilities=>cr_lf.
lv_string_3728 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_3728 lv_crlf_3728 wa_csv INTO lv_string_3728.
  CLEAR: wa_csv.
ENDLOOP.
TRANSFER lv_string_3728 TO lv_fullfile.
    CONCATENATE 'File' lv_fullfile 'downloaded' INTO lv_msg SEPARATED BY space.
    MESSAGE lv_msg TYPE 'S'.
*  ELSE.
*     lv_file = 'ZSALE.TXT'.
