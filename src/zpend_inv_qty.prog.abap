...
PARAMETERS: p_down   AS CHECKBOX,
            p_folder LIKE rlgrap-filename DEFAULT '/Delval/India'.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  lv_file = 'ZPEND_INV.TXT'.

  CONCATENATE p_folder '/' lv_file
  INTO lv_fullfile.
*  BREAK primus.
  WRITE: / 'ZPEND_INV Download started on', sy-datum, 'at', sy-uzeit.
  OPEN DATASET lv_fullfile
  FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_567 TYPE string.
DATA lv_crlf_567 TYPE string.
lv_crlf_567 = cl_abap_char_utilities=>cr_lf.
lv_string_567 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_567 lv_crlf_567 wa_csv INTO lv_string_567.
  CLEAR: wa_csv.
ENDLOOP.
*TRANSFER lv_string_1019 TO lv_fullfile.
TRANSFER lv_string_567 TO lv_fullfile.
