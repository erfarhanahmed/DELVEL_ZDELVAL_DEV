...
TABLES: TCURX,         " Dezimalstellen der Währungen
...
*     Feld fuer Schluesselwort "Währung"
...
*     Summenbericht: Wieviel Zeilen fuer Summenstufe reservieren?
      CON_RESRV(2) TYPE P,
*     Summenbericht: Länge Gruppenstufentext.
      CON_LGTXT(2) TYPE P VALUE 30,
*     Summenbericht: Minimale Länge Gruppenstufentext.
      CON_LGMIN(2) TYPE P VALUE 15,
*     Summenbericht: Maximale Länge Gruppenstufentext.
...
* Summenbericht: Tabelle mit den Summen zur Übergabe.
...
*     Anlagengitter vollständig oder unvollständig.
      SAV_COMPLTXT(15)   TYPE C.

* Nachfolgende Daten sind für die Realisierung eines PickUps auf
* Gruppensummen, um dann ein Einzelreporting durchzuführen
DATA: HLP_FELD(20).
...
* Flag, ob PickUp einer Zeile möglich ist.
...
* Aufbau einer internen Tabelle für Select-Option Kostenstelle
* bei Pick-Up.
DATA: BEGIN OF SAV_SO_KOSTL OCCURS 2.
        INCLUDE STRUCTURE SO_KOSTL.
DATA: END OF SAV_SO_KOSTL.

* Aufbau einer internen Tabelle für Select-Option Geschäftsbereich
* bei Pick-Up.
DATA: BEGIN OF SAV_SO_GSBER OCCURS 2.
        INCLUDE STRUCTURE SO_GSBER.
DATA: END OF SAV_SO_GSBER.

* Interne Tabelle für Speichern der Select-Options beim Start des Report
...
* Nachfolgende Daten sind für die Benutzung der Bericht-Bericht-
* Schnittstelle notwendig.
*     Report
DATA: TOOL LIKE TRSTI-STOOL VALUE 'RT',
*     Applikation
      APPL LIKE TRSTI-SAPPL VALUE '    ',
*     Subapplikation (hier nicht benötigt)
      SUBC LIKE TRSTI-SSUBC VALUE '  '.

*     Daten zum Empfängerbericht.
DATA: BEGIN OF A_REC.
...
*     Feldkatalog: Empfängerbericht.
DATA: BEGIN OF IT_FIELDR OCCURS 0.
        INCLUDE STRUCTURE RSTIFIELDS.
DATA: END   OF IT_FIELDR.

*     Selektionsdaten: Empfänger-Ausprägungen.
...
*     Interner Reportname für die BBS.
...
* Selektionsoptionen für die BBS - Aufruf von den Investitions-
* programmen
...
*        eigene Domäne (secret channel), dadurch kein
...
* Diese sind als Felder in der ANLAV und können deshalb selektiert
* werden.

* Konstanten für den Absprung vom RAHERK
