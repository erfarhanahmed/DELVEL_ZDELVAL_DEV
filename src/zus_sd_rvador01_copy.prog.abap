...
*&
*&---------------------------------------------------------------------*
REPORT ZUS_SD_RVADOR01_COPY LINE-COUNT 100 MESSAGE-ID vn.
...
*data : tvbdpa type table of vbdpa.
*data : tvbdpa type STANDARD TABLE OF VBDPA.
*data : tvbdpau type standard table of VBDPAU.
...
*data : tvbdpa type table of ztt_VBDPA.
*data : tvbdpau type table of ztt_VBDPAU.
...
FORM processing using    iv_screen  type c
  ...
  DATA: lf_fm_name            TYPE funcname. "rs38l_fnam.
...
*   error handling
 ...
 CALL FUNCTION lf_fm_name "'/1BCDWB/SM00000132'
   EXPORTING
*    /1BCDWB/DOCPARAMS        =
     is_vbdka                 =  vbdka
     is_nast                  = nast
