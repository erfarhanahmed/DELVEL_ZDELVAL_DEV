...
SELECT-OPTIONS : s_so  FOR vbak-vbeln,
                 ...
                 s_plant FOR vbap-werks DEFAULT 'SU01' NO INTERVALS MODIF ID BU.
SELECTION-SCREEN END OF BLOCK b1.

SELECTION-SCREEN BEGIN OF BLOCK b2 WITH FRAME TITLE TEXT-002 .
PARAMETERS: p_down   AS CHECKBOX,
            p_folder LIKE rlgrap-filename DEFAULT '/delval/Saudi'. "'/delval/Saudi'.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  lv_file = 'ZSU_PEND_INV.TXT'.

*  CONCATENATE p_folder '\' lv_file
  CONCATENATE p_folder '/' lv_file
  INTO lv_fullfile.
*  BREAK primus.
  WRITE: / 'ZSU_PEND_INV Download started on', sy-datum, 'at', sy-uzeit.
  OPEN DATASET lv_fullfile
  FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_576 TYPE string.
DATA lv_crlf_576 TYPE string.
lv_crlf_576 = cl_abap_char_utilities=>cr_lf.
lv_string_576 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_576 lv_crlf_576 wa_csv INTO lv_string_576.
  CLEAR: wa_csv.
ENDLOOP.
