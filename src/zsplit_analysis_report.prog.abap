...
TYPES: BEGIN OF TY_VBAK,
         ...
         KKBER TYPE VBAK-KKBER,     "Added by VSE 07/08.2025
...
FORM GET_DATA .
  ...
  SELECT VBELN
         ...
         OBJNR
         KKBER
         CMWAE FROM VBAK INTO TABLE IT_VBAK
...
FORM SORT_DATA .
  ...
  LOOP AT IT_VBAP INTO WA_VBAP.
    ...
    IF SY-SUBRC = 0.
      ...
      WA_FINAL-KKBER = WA_VBAK-KKBER.
      WA_FINAL-CMWAE = WA_VBAK-CMWAE.
...
FORM GET_FCAT .
  PERFORM FCAT USING : '1'   'VBELN'           'IT_FINAL'      'Sale Order '                 '20' ,
                       ...
                       '26'   'PO_NETPR'          'IT_FINAL'      'Sale Order Rate'         '20' ,
                       '27'   'SO_NETPR'          'IT_FINAL'      'Purchase Order Rate'         '20' ,
                       '28'   'PRS_MAT'           'IT_FINAL'      'Pricing Date Match'         '20' ,
                       '29'   'KUR_MAT'           'IT_FINAL'      'Exchange Rate Match'         '20' ,
                       '30'   'H_PRI_BLOCK'           'IT_FINAL'      'Header Pricing Block'         '20' ,
                       '31'   'I_PRI_BLOCK'           'IT_FINAL'      'Item Pricing Block'         '20' ,
                       '32'   'RELASE'            'IT_FINAL'        'Commercial Relase'             '15',
                       '33'   'KDTXT'            'IT_FINAL'         'Customer Group'             '20',
                       '34'   'KKBER'            'IT_FINAL'         'Credit Control Area'          '20',
                       '35'   'CMWAE'            'IT_FINAL'         'Currency'                  '20'.
