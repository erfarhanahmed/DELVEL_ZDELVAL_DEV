  ...
  SELECT SINGLE xblnr
    ...
    CONCATENATE ls_bil_invoice-hd_gen-BIL_DATE+6(2) '/'
            ls_bil_invoice-hd_gen-BIL_DATE+4(2) '/'
            ls_bil_invoice-hd_gen-BIL_DATE+0(4) '/'
            INTO gv_date.
...
* Ftech info for Mode Of Transport
  ...
  CONDENSE gv_trnsprt_mode.
    ...
    PERFORM get_text USING objname 'VBBK' 'ZZ1' 'E'
                      CHANGING gv_exp.
  CONDENSE gv_exp.

  PERFORM get_text USING objname 'VBBK' 'ZZ2' 'E'
                      CHANGING gv_lut.
  CONDENSE gv_lut.

  PERFORM get_text USING objname 'VBBK' 'ZZ3' 'E'
                      CHANGING gv_lut.
  CONDENSE gv_sez.
...
* Get Transporter
  PERFORM get_text USING objname 'VBBK' 'Z025' 'E'
                   CHANGING gv_lr_dt.
  CONDENSE gv_lr_dt.
