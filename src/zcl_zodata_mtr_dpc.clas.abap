class ZCL_ZODATA_MTR_DPC definition
  public
...
protected section.
  ...
  methods MTRSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZODATA_MTR_MPC=>TS_MTR
    raising
  ...
  methods MTRSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZODATA_MTR_MPC=>TT_MTR
...
CLASS ZCL_ZODATA_MTR_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 20.08.2018 15:40:29 in client 010
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZODATA_MTR_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA mtrset_create_entity TYPE zcl_zodata_mtr_mpc=>ts_mtr.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA mtrset_get_entity TYPE zcl_zodata_mtr_mpc=>ts_mtr.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZODATA_MTR_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA mtrset_get_entityset TYPE zcl_zodata_mtr_mpc=>tt_mtr.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA mtrset_update_entity TYPE zcl_zodata_mtr_mpc=>ts_mtr.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*  Data declaration
*-------------------------------------------------------------
 data LV_AUFNR type ZIF_ZMTR=>AFPO-AUFNR.
 data LT_FINAL  type ZIF_ZMTR=>__ZSTR_FINAL.
 data LS_LT_FINAL  type line of ZIF_ZMTR=>__ZSTR_FINAL.
