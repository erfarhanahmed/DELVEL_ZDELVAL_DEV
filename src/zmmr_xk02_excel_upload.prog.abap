...
REPORT ZMMR_XK02_EXCEL_UPLOAD.

*&---------------------------------------------------------------------*
*&  Include           ZMMI_MM02_EXCEL_UPLOAD_FORMAT
*&---------------------------------------------------------------------*
INCLUDE ZMMI_XK02_EXCEL_UPLOAD_FORMAT.
*INCLUDE ZMMI_MM02_EXCEL_UPLOAD_FORMAT.
...
***START OF COLUMN NUMBERS
    ...
    WA_DATA-FIELD1   = 'Vendor Number'.
    WA_DATA-FIELD2   = 'Company Code'.
    WA_DATA-FIELD3   = 'GST Number (Tax Number 3)'.
    WA_DATA-FIELD4   = 'Vendor Classification for GST'.
...
* CREATE FIRST EXCEL SHEET
  ...
  SHEET
  'ACTIVATE'.
  SET PROPERTY OF SHEET 'NAME' = 'Vendor Master Data'.
