*&---------------------------------------------------------------------*
*& Report ZINFO_RECORD_EXCEL
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZSU_INFO_RECORD_EXCEL.

INCLUDE ZSU_INFO_RECORD_EXCEL_FORMAT.
*INCLUDE ZINFO_RECORD_EXCEL_format.
...
***START OF COLUMN NUMBERS
  ...
  wa_data-field1  = 'Vendor'.
  wa_data-field2  = 'Material'.
  wa_data-field3  = 'Purchasing Or'.
  wa_data-field4  = 'Plant'.
  wa_data-field5  = 'Quantity'.
  wa_data-field6  = 'Tax Code'.
  wa_data-field7  = 'Net Price'.
  wa_data-field8  = 'Upper Limit'.
  wa_data-field9  = 'Validity Upto'.
  wa_data-field10  = 'Vendor Mat. No.'.
  wa_data-field11  = 'Casting Weight'.
