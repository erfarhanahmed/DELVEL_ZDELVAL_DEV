...
**  IF sy-subrc = 0.
**
**    inwords = amt_in_words-word.
**    grosze = amt_in_words-decimal / 10.
**    amt_in_words-decimal = amt_in_words-decimal / 10.
**    dziesiatki = amt_in_words-decimal(3).
...
**
**    CONCATENATE dziesiatki+1(2) '/100' INTO tmpslo.
**
