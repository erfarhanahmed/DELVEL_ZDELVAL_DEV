...
REPORT ZSDR_XD02_EXCEL_UPLOAD.

*&---------------------------------------------------------------------*
*&  Include           ZMMI_MM02_EXCEL_UPLOAD_FORMAT
*&---------------------------------------------------------------------*
INCLUDE ZSDI_XD02_EXCEL_UPLOAD_FORMAT.
*INCLUDE ZMMI_MM02_EXCEL_UPLOAD_FORMAT.
...
***START OF COLUMN NUMBERS
    ...
    WA_DATA-FIELD1   = 'Customer Account Number'.
    WA_DATA-FIELD2   = 'Company Code'.
*    WA_DATA-FIELD3   = 'Plant'.
    WA_DATA-FIELD3   = 'Sales Organization'.
    WA_DATA-FIELD4   = 'Distribution Channel'.
    WA_DATA-FIELD5   = 'Division'.
    WA_DATA-FIELD6   = 'GST Number (Tax Number 3)'.
    WA_DATA-FIELD7   = 'Tax classification for customer 1'.
    WA_DATA-FIELD8  = 'Tax classification for customer 2'.
    WA_DATA-FIELD9  = 'Tax classification for customer 3'.
    WA_DATA-FIELD10  = 'Tax classification for customer 4'.
    WA_DATA-FIELD11  = 'Tax classification for customer 5'.
    WA_DATA-FIELD12  = 'Tax classification for customer 6'.
*    WA_DATA-FIELD13  = 'Tax classification for customer 7'.
*    WA_DATA-FIELD14  = 'Tax classification for customer 8'.
...
* CREATE FIRST EXCEL SHEET
  ...
  SHEET
  'ACTIVATE'.
  SET PROPERTY OF SHEET 'NAME' = 'Customer Master Data'.
