...
*&
*&---------------------------------------------------------------------*
REPORT ZINVENTORY_AGEING_DETAILS.
...
*        labst TYPE mard-labst,
      ...
      BEGIN OF TY_FINAL,
        ...
        LGORT    TYPE MSEG-LGORT,
        LIFNR    TYPE MSEG-LIFNR,
        DMBTR    TYPE CHAR256,        "MSEG-DMBTR,
        DMBTR_SO TYPE CHAR256,        "MSEG-DMBTR,
        MENGE    TYPE CHAR256,        "MSEG-MENGE,
        MENGE_SO TYPE CHAR256,        "MSEG-MENGE,
        BUKRS    TYPE MSEG-BUKRS,
        DATE     TYPE MKPF-BUDAT,
        BLDAT    TYPE MKPF-BLDAT,
        DAY      TYPE INT4,
        QTY      TYPE CHAR256,        "MSEG-MENGE,
        TEXT     TYPE STRING,
...
START-OF-SELECTION.
  ...
  PERFORM GET_DATA.
  PERFORM SORT_DATA.
  EXPORT IT_DOWN TO MEMORY ID 'ZINVENTORY'.
  PERFORM DISPLAY.
*&---------------------------------------------------------------------*
*&      Form  GET_DATA
*&---------------------------------------------------------------------*
...
*  DATA : zrate   TYPE zrate.
  DATA : ZRATE   TYPE P DECIMALS 2."6.
...
* Implement suitable error handling here
  ...
  IF P_DOWN = 'X'.
    ...
    PERFORM DOWNLOAD TABLES IT_DOWN USING P_FOLDER P_LGORT."IT_FINAL USING P_FOLDER P_LGORT.
