...
SELECT-OPTIONS : S_VBELN FOR VBAP-VBELN,
                 ...
                 S_WERKS FOR VBAP-WERKS default 'SU01' MODIF ID BU.
...
* Implement suitable error handling here
  ...
  LV_FILE = 'ZSU_SO_MRPDATE.TXT'.

  CONCATENATE P_FOLDER '/' LV_FILE
*  CONCATENATE P_FOLDER '\' LV_FILE
  INTO LV_FULLFILE.
* BREAK primus.
  WRITE: / 'ZSU_SO MRP DATE Download started on', SY-DATUM, 'at', SY-UZEIT.
  OPEN DATASET LV_FULLFILE
  FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF SY-SUBRC = 0.
DATA lv_string_787 TYPE string.
DATA lv_crlf_787 TYPE string.
lv_crlf_787 = cl_abap_char_utilities=>cr_lf.
lv_string_787 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_787 lv_crlf_787 wa_csv INTO lv_string_787.
  CLEAR: wa_csv.
ENDLOOP.
TRANSFER lv_string_787 TO lv_fullfile.
