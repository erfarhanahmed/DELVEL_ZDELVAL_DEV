...
PARAMETERS p_folder LIKE rlgrap-filename DEFAULT   '/Delval/USA'.    "'E:/Delval/USA'."USA'."USA'."USA'."USA'.
...
DELETE IT_MARD WHERE labst EQ 0 AND insme EQ 0 .
  ...
  DELETE it_vbak WHERE auart = 'US03' .
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  ...
  IF sy-subrc = 0.
DATA lv_string_2172 TYPE string.
DATA lv_crlf_2172 TYPE string.
lv_crlf_2172 = cl_abap_char_utilities=>cr_lf.
lv_string_2172 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_2172 lv_crlf_2172 wa_csv INTO lv_string_2172.
  CLEAR: wa_csv.
ENDLOOP.
*TRANSFER lv_string_1008 TO lv_fullfile.
*TRANSFER lv_string_1008 TO lv_fullfile.
TRANSFER lv_string_2172 TO lv_fullfile.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  ...
  OPEN DATASET lv_fullfile
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_2209 TYPE string.
DATA lv_crlf_2209 TYPE string.
lv_crlf_2209 = cl_abap_char_utilities=>cr_lf.
lv_string_2209 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_2209 lv_crlf_2209 wa_csv INTO lv_string_2209.
  CLEAR: wa_csv.
ENDLOOP.
*TRANSFER lv_string_1008 TO lv_fullfile.
*TRANSFER lv_string_1008 TO lv_fullfile.
TRANSFER lv_string_2209 TO lv_fullfile.
    CONCATENATE 'File' lv_fullfile 'downloaded' INTO lv_msg SEPARATED BY space.
    MESSAGE lv_msg TYPE 'S'.
  ENDIF.
ENDFORM.
