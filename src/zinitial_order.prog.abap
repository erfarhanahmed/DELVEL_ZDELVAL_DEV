...
*        wa_vbrk TYPE ty_vbrk.
 ...
 TYPES : BEGIN OF ty_konv,
           ...
           zkwert_1 TYPE prcd_elements-kwert,
         END OF ty_konv.
 ...
 DATA : it_final TYPE STANDARD TABLE OF zsalesorder_str_new,
        wa_final TYPE zsalesorder_str_new.

 DATA : gt_lines TYPE TABLE OF tline,
        ls_lines TYPE tline.

 DATA:  fm_name TYPE rs38l_fnam,
       E_FUNCNM TYPE FUNCNAME .             " Name of the Function Module

************************************************************************
* Constant Declaration
************************************************************************

 CONSTANTS : sf_name TYPE tdsfname VALUE 'ZINITIAL_ORDER'.
