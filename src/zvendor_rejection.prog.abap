...
TYPES : BEGIN OF TY_FINAL,
        ...
        BEGIN OF STR,
          ...
          RM01_MENGE TYPE CHAR15,
          TPI1_MENGE TYPE CHAR15,
          RJ01_MENGE TYPE CHAR15,
          RWK1_MENGE TYPE CHAR15,
          LGPBE      TYPE MARD-LGPBE,
          REW_QTY    TYPE CHAR15,
          SCR1_MENGE TYPE CHAR15,
          SRN1_MENGE TYPE CHAR15,
          TOTAL_REJ  TYPE CHAR15,
          SRN_VENDOR TYPE MKPF-BKTXT,
          MATTXT     TYPE CHAR100,
          ZSERIES    TYPE MARA-ZSERIES,
          ZSIZE      TYPE MARA-ZSIZE,
...
*BREAK primus.
    ...
    LS_FINAL-RM01_MENGE   = WA_FINAL-RM01_MENGE.
    LS_FINAL-TPI1_MENGE   = WA_FINAL-TPI1_MENGE.
    LS_FINAL-RJ01_MENGE   = WA_FINAL-RJ01_MENGE.
    LS_FINAL-RWK1_MENGE   = WA_FINAL-RWK1_MENGE.
    LS_FINAL-LGPBE             = WA_FINAL-LGPBE       .
    LS_FINAL-REW_QTY           = WA_FINAL-REW_QTY     .
    LS_FINAL-SCR1_MENGE        = WA_FINAL-SCR1_MENGE  .
    LS_FINAL-SRN1_MENGE        = WA_FINAL-SRN1_MENGE  .
    LS_FINAL-TOTAL_REJ         = WA_FINAL-TOTAL_REJ   .
    LS_FINAL-SRN_VENDOR        = WA_FINAL-SRN_VENDOR  .
    ...
    LS_FINAL-LAGORTVORG        = WA_FINAL-LAGORTVORG.      " added by supriya :102423: 24:06:2024
...
*BREAK primus.
   if LS_FINAL-LAGORTVORG+0(1) NE 'K'.
    APPEND LS_FINAL TO LT_FINAL.
    endif.
     if WA_FINAL-LAGORTVORG+0(1) NE 'K'.
...
*  ls_fcat-fieldname = 'LMENGE01'.
  ...
  LS_FCAT-COL_POS   = '11'.
  LS_FCAT-FIELDNAME = 'RM01_MENGE'.
  LS_FCAT-SELTEXT_M = 'ACCEPTED QTY'.
  APPEND  LS_FCAT TO LT_FCAT.
  CLEAR LS_FCAT.

  LS_FCAT-COL_POS   = '12'.
  LS_FCAT-FIELDNAME = 'TPI1_MENGE'.
  LS_FCAT-SELTEXT_M = 'TPI STOCK'.
  APPEND  LS_FCAT TO LT_FCAT.
  CLEAR LS_FCAT.

  LS_FCAT-COL_POS   = '13'.
  LS_FCAT-FIELDNAME = 'RJ01_MENGE'.
  LS_FCAT-SELTEXT_M = 'REJECTED QTY'.
  APPEND  LS_FCAT TO LT_FCAT.
  CLEAR LS_FCAT.

  LS_FCAT-COL_POS   = '14'.
  LS_FCAT-FIELDNAME = 'RWK1_MENGE'.
...
*  ls_fcat-fieldname = 'SRN1_MENGE'.
  ...
  LS_FCAT-COL_POS   = '31'.               "Added By Snehal Rajale ON 01.02.2021
  LS_FCAT-FIELDNAME = 'SGTXT1'.
  LS_FCAT-SELTEXT_M = 'TEXT'.
  APPEND  LS_FCAT TO LT_FCAT.
  CLEAR LS_FCAT.

  LS_FCAT-COL_POS   = '32'.               "Added By Snehal Rajale ON 07.04.2021
  LS_FCAT-FIELDNAME = 'KURZTEXT'.
  LS_FCAT-SELTEXT_M = 'UD CODE DESCRIPTION'.
  APPEND  LS_FCAT TO LT_FCAT.
  CLEAR LS_FCAT.

  LS_FCAT-COL_POS   = '33'.               " added by supriya :102423: 24:06:2024
  LS_FCAT-FIELDNAME = 'LAGORTVORG'.
...
*  CONCATENATE 'DAILY DISPATCH REPORT'." LS_MONTH_NAME SY-DATUM+0(4) INTO GS_STRING SEPARATED BY ' '.
  LS_LISTHEADER-TYP = 'H'.
  LS_LISTHEADER-INFO = 'VENDOR REJECTION REPORT FOR SHIRVAL LOCATION'."GS_STRING.
  APPEND LS_LISTHEADER TO LT_LISTHEADER.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  LV_FILE = 'ZVREJ_SHR.TXT'.

  CONCATENATE P_FOLDER '/' LV_FILE
    INTO LV_FULLFILE.
*BREAK primus.
  WRITE: / 'ZVREJ_SHR Download started on', SY-DATUM, 'at', SY-UZEIT.
  OPEN DATASET LV_FULLFILE
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF SY-SUBRC = 0.
DATA lv_string_1310 TYPE string.
DATA lv_crlf_1310 TYPE string.
lv_crlf_1310 = cl_abap_char_utilities=>cr_lf.
lv_string_1310 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1310 lv_crlf_1310 wa_csv INTO lv_string_1310.
  CLEAR: wa_csv.
ENDLOOP.
*TRANSFER lv_string_778 TO lv_fullfile.
*TRANSFER lv_string_2366 TO lv_fullfile.
TRANSFER lv_string_1310 TO lv_fullfile.
...
FORM CVS_HEADER  USING PD_CSV.
  ...
  CONCATENATE 'VENDOR'
              ...
              'UD CODE DESCRIPTION'           "Added By Snehal Rajale ON 07.04.2021
...
*  delete IT_MARD WHERE LGORT+0(1) ne 'K'.
...
*BREAK primus.
    ...
    CONCATENATE LS_FINAL-REF+0(2) LS_FINAL-REF+2(3) LS_FINAL-REF+5(4)
                    INTO LS_FINAL-REF SEPARATED BY '-'.
*BREAK primus.
   if LS_FINAL-LAGORTVORG+0(1) EQ 'K'.
    APPEND LS_FINAL TO LT_FINAL.
    endif.
     if WA_FINAL-LAGORTVORG+0(1) EQ 'K'.
    APPEND WA_FINAL TO IT_FINAL.
    endif.
    CLEAR : WA_FINAL ,LS_FINAL,LS_AUFK,WA_LFA1,WA_MAKT,WA_MARA,WA_QALS,LS_MKPF,LS_QPCT.
    REFRESH IT_LINE.
...
*  CONCATENATE 'DAILY DISPATCH REPORT'." LS_MONTH_NAME SY-DATUM+0(4) INTO GS_STRING SEPARATED BY ' '.
  LS_LISTHEADER-TYP = 'H'.
  LS_LISTHEADER-INFO = 'VENDOR REJECTION REPORT FOR KPR LOCATION'."GS_STRING.
  APPEND LS_LISTHEADER TO LT_LISTHEADER.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  LV_FILE = 'ZVREJ_KPR.TXT'.

  CONCATENATE P_FOLDER '/' LV_FILE
    INTO LV_FULLFILE.
*BREAK primus.
  WRITE: / 'ZVREJ_KPR Download started on', SY-DATUM, 'at', SY-UZEIT.
  OPEN DATASET LV_FULLFILE
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF SY-SUBRC = 0.
DATA lv_string_2366 TYPE string.
DATA lv_crlf_2366 TYPE string.
lv_crlf_2366 = cl_abap_char_utilities=>cr_lf.
lv_string_2366 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_2366 lv_crlf_2366 wa_csv INTO lv_string_2366.
  CLEAR: wa_csv.
ENDLOOP.
*TRANSFER lv_string_778 TO lv_fullfile.
*TRANSFER lv_string_2366 TO lv_fullfile.
