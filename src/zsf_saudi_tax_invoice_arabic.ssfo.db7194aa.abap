...
SELECT SINGLE *
       FROM adrc
       INTO gs_adrc_a
       WHERE addrnumber = lv_adrnr AND NATION ='A'.

DATA : av_cname1 TYPE adrc-name1.

CALL FUNCTION 'STRING_REVERSE'
  EXPORTING
    STRING          = gs_adrc_a-NAME1
    LANG            = 'A'
 IMPORTING
   RSTRING         = av_cname1
* EXCEPTIONS
...
DATA : av_cname2 TYPE adrc-name2.

CALL FUNCTION 'STRING_REVERSE'
  EXPORTING
    STRING          = gs_adrc_a-NAME2
    LANG            = 'A'
 IMPORTING
   RSTRING         = av_cname2
* EXCEPTIONS
...
DATA :  av_street  TYPE adrc-street.

CALL FUNCTION 'STRING_REVERSE'
  EXPORTING
    STRING          = gs_adrc_a-STREET
    LANG            = 'A'
 IMPORTING
   RSTRING         = av_street
* EXCEPTIONS
...
DATA :  av_adnumber  TYPE adrc-ADDRNUMBER.

CALL FUNCTION 'STRING_REVERSE'
  EXPORTING
    STRING          = gs_adrc_a-ADDRNUMBER
    LANG            = 'A'
 IMPORTING
   RSTRING         = av_adnumber
* EXCEPTIONS
...
* Implement suitable error handling here
ENDIF.
ARADDNUMBER = av_adnumber.


DATA :  av_district  TYPE adrc-ADDRNUMBER.
...
* Implement suitable error handling here
ENDIF.
ARDISTRICT = av_adnumber.

DATA :  av_city  TYPE adrc-CITY1.
