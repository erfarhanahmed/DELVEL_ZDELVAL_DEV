*----------------------------------------------------------------------*
*
* OBJECT ID              :  ZMM_PURCHASE_ORDER_DRVR
* FUNCTIONAL CONSULTANT  :  ABHINAY GANDHE
* TECHNICAL CONSULTANT   :  MANISHA BHOSALE / BHASKER REDDY
...
*----------------------------------------------------------------------*
REPORT  zmm_purchase_order_drvr.
TYPE-POOLS meein .
