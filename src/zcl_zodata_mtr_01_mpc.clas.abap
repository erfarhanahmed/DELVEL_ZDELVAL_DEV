class ZCL_ZODATA_MTR_01_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZODATA_MTR_01_MPC=========CP' ##NO_TEXT.
...
CLASS ZCL_ZODATA_MTR_01_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZODATA_MTR_SRV_01' ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CustomerName' iv_abap_fieldname = 'KUNNR' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZODATA_MTR_01_MPC=>TS_MTR' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20180824121521'.                  "#EC NOTEXT
