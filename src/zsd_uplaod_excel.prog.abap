*&---------------------------------------------------------------------*
*& Report ZSD_UPLAOD_EXCEL
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZSD_UPLAOD_EXCEL.
INCLUDE ZSD_EXCEL_FORMAT.
...
***START OF COLUMN NUMBERS
    ...
    WA_DATA-FIELD1  = 'Customer No'.
    WA_DATA-FIELD2  = 'Company Code'.
    WA_DATA-FIELD3  = 'Sales Org'.
    WA_DATA-FIELD4  = 'Distribution Channel '.
    WA_DATA-FIELD5  = 'Division'.
    WA_DATA-FIELD6  = 'PAN No'.
    WA_DATA-FIELD7  = 'AADHAR No'.
    WA_DATA-FIELD8  = 'Tax Classification 6'.
...
* CREATE FIRST EXCEL SHEET
  ...
  SHEET
  'ACTIVATE'.
  SET PROPERTY OF SHEET 'NAME' = 'Customer Master'.
...
*************************************#*********
  ...
  EXPORTING
    #1       = 'D:\SAP_DATA\Upload_Customer_Master.XLS'     "FILENAME
    #2       = 1.                          "FILEFORMAT
