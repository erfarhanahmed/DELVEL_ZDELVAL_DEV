...
*MESSAGE 'This Tcode is discontinued. Kindly use zsos_ind Tcode' TYPE 'E'.
*MESSAGE 'This Tcode is discontinued. Kindly use ZSOS_DATE_CHNG Tcode' TYPE 'E'.
MESSAGE 'This Tcode is discontinued. Kindly use ZSOS_PRIMUS_NEW Tcode' TYPE 'E'.
...
PARAMETERS p_folder LIKE rlgrap-filename DEFAULT '/Delval/India'."India'."temp'.  "H:\planning\actuator'  ##NO_TEXT
    .
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  ...
  WRITE: / 'NEW SOS Download started on'      ##NO_TEXT
  ...
  IF sy-subrc = 0.
DATA lv_string_988 TYPE string.
DATA lv_crlf_988 TYPE string.
lv_crlf_988 = cl_abap_char_utilities=>cr_lf.
lv_string_988 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_988 lv_crlf_988 wa_csv INTO lv_string_988.
  CLEAR: wa_csv.
ENDLOOP.
