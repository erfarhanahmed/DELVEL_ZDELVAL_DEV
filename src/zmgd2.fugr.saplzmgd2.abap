...
*******************************************************************
  INCLUDE LZMGD2TOP.                         " Global Declarations
  INCLUDE LZMGD2UXX.                         " Function Modules

*******************************************************************
*   User-defined Include-files (if necessary).                    *
*******************************************************************
* INCLUDE LZMGD2F...                         " Subroutines
* INCLUDE LZMGD2O...                         " PBO-Modules
* INCLUDE LZMGD2I...                         " PAI-Modules
* INCLUDE LZMGD2E...                         " Events
* INCLUDE LZMGD2P...                         " Local class implement.
* INCLUDE LZMGD2T99.                         " ABAP Unit tests
