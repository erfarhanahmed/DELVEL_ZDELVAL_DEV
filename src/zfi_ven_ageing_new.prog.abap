...
*   PERFORM f_fieldcatalog USING '2'   'LIFNR'     'Vendor code '.
   ...
   PERFORM f_fieldcatalog USING '11'   'CURR'     'Amt Document Currency'.
   ...
   PERFORM f_fieldcatalog USING '15'  'NETBAL'    'Net Pending'.
   PERFORM f_fieldcatalog USING '16'  'NETB30'    rc13. "'Net Balance'.
   PERFORM f_fieldcatalog USING '17'  'NETB60'    rc14. "'Net Balance'.
   PERFORM f_fieldcatalog USING '18'  'NETB90'    rc15. "'Net Balance'.
   PERFORM f_fieldcatalog USING '19'  'NETB120'   rc16. "'Net Balance'.
   PERFORM f_fieldcatalog USING '20'  'NETB180'   rc17. "'Net Balance'.
   PERFORM f_fieldcatalog USING '21'  'NETB360'   rc18. "'Net Balance'.
   PERFORM f_fieldcatalog USING '22'  'NOT_DUE'   'Not Due'. "'Net Balance'.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
   ...
   IF sy-subrc = 0.
DATA lv_string_1648 TYPE string.
DATA lv_crlf_1648 TYPE string.
lv_crlf_1648 = cl_abap_char_utilities=>cr_lf.
lv_string_1648 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1648 lv_crlf_1648 wa_csv INTO lv_string_1648.
  CLEAR: wa_csv.
ENDLOOP.
