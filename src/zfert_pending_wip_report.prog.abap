...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  ...
  lv_file = 'ZFERT_WIP.TXT'.


  CONCATENATE p_folder '/' lv_file
    INTO lv_fullfile.

  WRITE: / 'ZFERT_WIP REPORT started on', sy-datum, 'at', sy-uzeit.
  OPEN DATASET lv_fullfile
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_542 TYPE string.
DATA lv_crlf_542 TYPE string.
lv_crlf_542 = cl_abap_char_utilities=>cr_lf.
lv_string_542 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_542 lv_crlf_542 wa_csv INTO lv_string_542.
  CLEAR: wa_csv.
ENDLOOP.
*TRANSFER lv_string_0 TO lv_fullfile.
*TRANSFER lv_string_396 TO lv_fullfile.
TRANSFER lv_string_542 TO lv_fullfile.
