...
*&---------------------------------------------------------------------*
*&  Include           ZMMI_MM02_EXCEL_UPLOAD_FORMAT
*&---------------------------------------------------------------------*
INCLUDE ZMMI_MM02_EXCEL_UPLOAD_FORMAT.
...
***START OF COLUMN NUMBERS
    ...
    WA_DATA-FIELD2   = 'Company Code'.
    WA_DATA-FIELD3   = 'Plant'.
    WA_DATA-FIELD4   = 'Sales Organization'.
    WA_DATA-FIELD5   = 'Distribution Channel'.
    WA_DATA-FIELD6   = 'Control Code'.
    WA_DATA-FIELD7   = 'Tax indicator for material (Purchasing)'.
    WA_DATA-FIELD8   = 'Tax category 1'.
    WA_DATA-FIELD9   = 'Tax classification material 1'.
    WA_DATA-FIELD10  = 'Tax category 2'.
    WA_DATA-FIELD11  = 'Tax classification material2'.
    WA_DATA-FIELD12  = 'Tax category 3'.
    WA_DATA-FIELD13  = 'Tax classification material3'.
    WA_DATA-FIELD14  = 'Tax category 4'.
    WA_DATA-FIELD15  = 'Tax classification material4'.
    WA_DATA-FIELD16  = 'Tax category 5'.
    WA_DATA-FIELD17  = 'Tax classification material5'.
    WA_DATA-FIELD18  = 'Tax category 6'.
    WA_DATA-FIELD19  = 'Tax classification material6'.
*    WA_DATA-FIELD20  = 'Tax category 7'.
*    WA_DATA-FIELD21  = 'Tax classification material7'.
*    WA_DATA-FIELD22  = 'Tax category 8'.
*    WA_DATA-FIELD23  = 'Tax classification material8'.
...
* CREATE FIRST EXCEL SHEET
  ...
  SHEET
  'ACTIVATE'.
  SET PROPERTY OF SHEET 'NAME' = 'Material Master Data'.
...
*************************************#*********
  ...
  EXPORTING
    #1       = 'D:\SAP_DATA\Upload_FERT_Finished_Material.XLS'     "FILENAME
