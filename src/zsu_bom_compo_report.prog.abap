...
SELECT-OPTIONS  : s_werks FOR mast-werks DEFAULT 'SU01' NO INTERVALS OBLIGATORY MODIF ID BU,
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  ...
  IF sy-subrc = 0.
DATA lv_string_812 TYPE string.
DATA lv_crlf_812 TYPE string.
lv_crlf_812 = cl_abap_char_utilities=>cr_lf.
lv_string_812 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_812 lv_crlf_812 wa_csv INTO lv_string_812.
  CLEAR: wa_csv.
ENDLOOP.
