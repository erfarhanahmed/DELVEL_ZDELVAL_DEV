...
DATA BASAMT TYPE STRING .
DATA DIS TYPE STRING .
DATA DIS3 TYPE STRING .
...
TYPES:
  BEGIN OF T_SKAT,
    ...
    TXT50 TYPE SKAT-TXT50,                                         "ADDED BY AAKASHK 17.10.2024
  END OF T_SKAT,
  TT_SKAT TYPE STANDARD TABLE OF T_SKAT.

*  TYPES:
*  BEGIN OF T_SKA1,                                                     "ADDED BY AAKASHK 17.10.2024
*    SAKNR TYPE SKA1-SAKNR,
*    TXT50 TYPE SKA1-TXT50,
...
TYPES:BEGIN OF TY_EWAY,
        ...
        EWAYBILLDATE  TYPE ZEWAY_NUMBER-EWAYBILLDATE,
        VDFMTIME      TYPE ZEWAY_NUMBER-VDFMTIME,
        VALIDUPTODATE TYPE ZEWAY_NUMBER-VALIDUPTODATE,
        VDTOTIME      TYPE ZEWAY_NUMBER-VDTOTIME,
      END OF TY_EWAY.

TYPES:BEGIN OF TY_EWAYEX,
...
DATA : IT_EWAY   TYPE TABLE OF TY_EWAY,
       ...
       IT_EWAYEX TYPE TABLE OF TY_EWAYEX,
       WA_EWAYEX TYPE          TY_EWAYEX,

       IT_EINV   TYPE TABLE OF TY_EINV,
       WA_EINV   TYPE          TY_EINV.
TYPES :
  BEGIN OF T_SAL_TXT,
...
*********************************************
DATA VAL_INR2 TYPE P DECIMALS 2.
...
*    BASE_VAL       TYPE PRCD_ELEMENTS-KWERT,        "Base Price
    BASE_VAL       TYPE STRING,        "Base Price
    ASS_VAL2       TYPE P DECIMALS 2, " string,"PRCD_ELEMENTS-KWERT,        "Base Price
    ASS_VAL        TYPE  STRING, "PRCD_ELEMENTS-KWERT,        "Base Price
    WAERK          TYPE VBRK-WAERK,      "Currency
    KURSK          TYPE VBRP-KURSK,      "Exchange Rate
    VAL_INR        TYPE STRING, "VBRP-NETWR,      "Amount in Local Currency
    PF_VAL         TYPE PRCD_ELEMENTS-KWERT,        "P&F
    DIS            TYPE STRING, "P DECIMALS 2, " "PRCD_ELEMENTS-KWERT,        "Discount
    DIS2           TYPE STRING, " "PRCD_ELEMENTS-KWERT,        "Discount
    DIS3           TYPE  P DECIMALS 2, " " "PRCD_ELEMENTS-KWERT,        "Discount
    DIS_AMT        TYPE  STRING, "P DECIMALS 2, "CHAR20,        "Discount
    DIS_AMT2       TYPE  P DECIMALS 2,        "Discount
    DIS_UNIT_RATE  TYPE  STRING, "PRCD_ELEMENTS-KWERT,        "Discount
    DIS_UNIT_RATE2 TYPE P DECIMALS 2, " string,"PRCD_ELEMENTS-KWERT,        "Discount
*    DIS_RATE       TYPE PRCD_ELEMENTS-KBETR,        "Discount
    DIS_RATE       TYPE P DECIMALS 2,        "Discount
    TOT_ASS        TYPE STRING, "PRCD_ELEMENTS-KBETR,        "Discount
    ASS2_VAL       TYPE STRING, "PRCD_ELEMENTS-KWERT,        "Assessable
    EXE_VAL        TYPE STRING, "PRCD_ELEMENTS-KWERT,        "Excise Duty
    EDU_VAL        TYPE STRING, "PRCD_ELEMENTS-KWERT,        "Education Cess Amount
    HSE_VAL        TYPE STRING, "PRCD_ELEMENTS-KWERT,        "Higher Education Cess Amount
    VAT            TYPE PRCD_ELEMENTS-KWERT,        "VAT/CST
    FRT            TYPE PRCD_ELEMENTS-KWERT,        "Freight
    INS            TYPE PRCD_ELEMENTS-KWERT,        "Insurance
    TES            TYPE PRCD_ELEMENTS-KWERT,              "Testing Charge
    ASS_GST        TYPE STRING, "PRCD_ELEMENTS-KWERT,              "Assessable GST
    ASS_GST2       TYPE P DECIMALS 2, "string,"PRCD_ELEMENTS-KWERT,              "Assessable GST
*    CGST_P         TYPE prcd_elements-KBETR,              "CGST %
    CGST_P         TYPE P DECIMALS 2,              "CGST %
    CGST           TYPE P DECIMALS 2,        "CGST
...
*    IGST_P         TYPE prcd_elements-KBETR,              "IGST %
    ...
    IGST           TYPE PRCD_ELEMENTS-KWERT,        "IGST
    COM_CESS       TYPE PRCD_ELEMENTS-KWERT,              "Comp Cess%
    COM_CESS_V     TYPE PRCD_ELEMENTS-KWERT,              "Comp Cess Amt
*    TCS_P          TYPE prcd_elements-KBETR,              "TCS Per
    TCS_P          TYPE P DECIMALS 2,              "TCS Per
    TCS            TYPE PRCD_ELEMENTS-KWERT,              "TCS amt
    TOT2           TYPE P DECIMALS 2, "string,"PRCD_ELEMENTS-KWERT,        "Grand Total
    TOT            TYPE STRING, "PRCD_ELEMENTS-KWERT,        "Grand Total
    ...
    STPRS          TYPE STRING, "MBEW-STPRS,        "Cost
    STPRS1         TYPE STRING, "MBEW-STPRS,        "Cost
...
*    tax_txt       TYPE t007s-text1,             "Tax Code Description
    EWAYNO         TYPE ZEWAY_NUMBER-EWAY_BILL,
    EWAYDATE       TYPE CHAR11, "ZEWAY_NUMBER-EWAYBILLDATE,
    VALIDUPTODATE  TYPE CHAR11, "ZEWAY_NUMBER-VALIDUPTODATE,
    ZZIRN_NO       TYPE ZEINV_RES-ZZIRN_NO,
    ZZQR_CODE      TYPE ZEINV_RES-ZZQR_CODE,
    ZZCDATE        TYPE CHAR11, "ZEINV_RES-ZZCDATE,
    ZZTIME         TYPE CHAR25, "ZEINV_RES-ZZTIME,

    IRN            TYPE J_1IG_INVREFNUM-IRN,
    SIGNED_QRCODE  TYPE J_1IG_INVREFNUM-SIGNED_QRCODE,
    ZTDLINE        TYPE CHAR25,
    ZINSURANCE_POL TYPE CHAR25,
    LGORT          TYPE VBRP-LGORT, "added by jyoti on 11.06.2024
    JTC            TYPE CHAR20, "added by jyoti on 21.10.2024
*     TXT50         TYPE SKAT-TXT50,              "TEXT FIELD                 "ADDED BY AAKASHK 17.10.2024
...
*    name2         TYPE kna1-name2,        "Customer Name
    ...
    TOT            TYPE STRING, "P DECIMALS 2, "CHAR100,        "Grand Total
    PRODH          TYPE VBRP-PRODH,      "Product Heirarchy
    STEUC          TYPE MARC-STEUC,        "HSN Code
    VTEXT          TYPE TVKTT-VTEXT,       "Sales Type Text
    TRANS          TYPE CHAR30,            "Transporter Name
...
*    NAME1_SH1      TYPE KNA1-NAME2,
    ...
    ASS_GST        TYPE STRING, "P DECIMALS 2, "CHAR100,              "Assessable GST
...
*    IGST_P         TYPE prcd_elements-KBETR,              "IGST %
    ...
    OFM_NO         TYPE STRING,
    EWAYNO         TYPE ZEWAY_NUMBER-EWAY_BILL,
    EWAYDATE       TYPE CHAR15,
    VALIDUPTODATE  TYPE CHAR15,
    ZZIRN_NO       TYPE ZEINV_RES-ZZIRN_NO,
    ZZQR_CODE      TYPE ZEINV_RES-ZZQR_CODE,
    ZZCDATE        TYPE CHAR15,
    ZZTIME         TYPE CHAR10,
...
FORM FETCH_DATA  CHANGING CT_FINAL TYPE TT_FINAL.
  DATA:
    ...
    LT_SKAT1               TYPE TT_SKAT,
    LS_SKAT                TYPE T_SKAT,
    LS_SKAT1               TYPE T_SKAT,
...
*    IF SY-SUBRC IS INITIAL."comment on 05.04.2024
...
*      select saknr                                                          "added by aakashk 17.10.2024
*             text50
*        from ska1
*        into table it_ska1
...
*        ENDIF.
    ...
    IF NOT LT_ACCOUNTING_DOC_ITEM IS INITIAL.
      ...
      SELECT SAKNR
             TXT20
             TXT50                                    "ADDED BY AAKASHK 17.10.2024
        FROM SKAT
        INTO TABLE LT_SKAT
     ...
     FROM SKAT
     INTO TABLE LT_SKAT1
        WHERE SAKNR = '0000240271'
        AND   SPRAS = 'EN'"SY-LANGU
     AND   KTOPL = '1000'.
...
*           DELDATE
    ...
    IF NOT LT_SALES_INV_ITEM IS INITIAL.
      ...
      SELECT VBELN
             ...
             VDFMTIME
             VALIDUPTODATE
             VDTOTIME      FROM ZEWAY_NUMBER INTO TABLE IT_EWAY
             FOR ALL ENTRIES IN LT_SALES_INV_HDR
             WHERE VBELN = LT_SALES_INV_HDR-VBELN.
      ...
      SELECT VBELN
             ...
             ZZQR_CODE
             ZZCDATE
             ZZTIME    FROM ZEINV_RES INTO TABLE IT_EINV
             FOR ALL ENTRIES IN LT_SALES_INV_HDR
             WHERE VBELN = LT_SALES_INV_HDR-VBELN.
...
***********************************************************************************************
*              READ TABLE LT_SKAT1 INTO LS_SKAT1 WITH KEY SAKNR = '0000240271'.
*          IF SY-SUBRC IS INITIAL.
**            LS_FINAL-VTEXT1 = LS_SKAT-TXT20.
*            LS_FINAL-TXT50 = LS_SKAT1-TXT50.                                        "ADDED BY AAKASHK 17.10.2024
*          ENDIF.
***********************************************************************************************
...
*********************************************************************************************************************************
*        read table it_ska1 into wa_ska1 with key saknr = LT_ACCOUNTING_DOC_ITEM-HKONT.           "ADDED BY AAKASHK 17.10.2024
*        IF SY-SUBRC = 0.
*          LS_FINAL-TXT50 = LT_ACCOUNTING_DOC_ITEM-TXT50.
*          ENDIF.
***********************************************************************************************************************************
...
*                                                                               posn2 = ls_sales_inv_item-aupos.
      IF SY-SUBRC IS INITIAL.
        ...
        IF SY-SUBRC IS INITIAL.
          LS_FINAL-VTEXT1 = LS_SKAT-TXT20.
*            LS_FINAL-TXT50 = LS_SKAT-TXT50.                                        "ADDED BY AAKASHK 17.10.2024
        ENDIF.
...
*        LS_FINAL-LGORT = LS_SALES_ORD_ITEM-LGORT."ADDED BY JYOTI ON 11.06.2024
*        ls_final-DELDATE = ls_sales_ord_item-DELDATE .
    ...
    IF SY-SUBRC IS INITIAL.
      ...
      LS_FINAL-NAME = LS_CUST_INFO-NAME1. " ADDED BY SHUBHANGI SARODE ON DT 19.02.2024 AS PER USER REQUIRMENT -REMOVED NAME2 FROM FILED.
...
*        ls_final-val_inr  = ls_conditions-kwert * ls_sales_inv_item-kursk.
      ...
      LS_FINAL-NETPR2    = LS_FINAL-BASE_VAL / LS_FINAL-FKIMG.
      LS_FINAL-NETPR = LS_FINAL-NETPR2.
      GV_KBETR3 = LS_CONDITIONS-KBETR  .
    ENDIF.
    "Discount Price
*    BREAK ctpl.
    ...
    BREAK ctpl.
    IF SY-SUBRC IS  INITIAL.
      LS_FINAL-DIS3 = LS_CONDITIONS2-KWERT * LS_SALES_INV_HDR-KURRF.
      LS_FINAL-DIS2 =   LS_FINAL-DIS3 .
*      IF LS_FINAL-DIS2 < 0 .
**        DIS3 =  LS_FINAL-DIS2 * ( -1 ).
*        CONCATENATE '-' DIS3 INTO LS_FINAL-DIS2 .
*        LS_FINAL-DIS = LS_FINAL-DIS2.
*      ENDIF.
      LS_FINAL-DIS = LS_FINAL-DIS2 .
...
*      LS_FINAL-DIS_AMT  = abs( LS_CONDITIONS2-KWERT ).
      LS_FINAL-DIS_AMT2  = ABS( GV_KBETR2 ).
      LS_FINAL-DIS_AMT = LS_FINAL-DIS_AMT2.
*        ls_final-dis = ls_conditions-kwert * ls_sales_inv_item-kursk.
    ELSE.

      LS_FINAL-DIS_UNIT_RATE2  = LS_CONDITIONS-KBETR.
      LS_FINAL-DIS_UNIT_RATE  = LS_FINAL-DIS_UNIT_RATE2.
      LS_FINAL-DIS_AMT = LS_FINAL-DIS_AMT2.
      LS_FINAL-DIS = '0'.
    ENDIF.
...
*     LS_FINAL-DIS_UNIT_RATE  = LS_FINAL-BASE_VAL - ( - LS_CONDITIONS2-KWERT ) .
    ...
    IF GV_KBETR IS NOT INITIAL.
      LS_FINAL-DIS_UNIT_RATE2  = GV_KBETR .
      LS_FINAL-DIS_UNIT_RATE = LS_FINAL-DIS_UNIT_RATE2.
    ENDIF.
    """""""""""""""""'COMMENT TEMP
*BREAK CTPL.
    ""assesable value
*    GV_Kwert2 = LS_FINAL-BASE_VAL - ( - GV_Kwert ). " ADDED BY MAHADEV HEMENT ON 10/12/2025
**    LS_FINAL-ASS2_VAL = GV_Kwert2 * wa_vbkd-KURSK . " ADDED BY MAHADEV HEMENT ON 10/12/2025
*    LS_FINAL-ASS2_VAL = GV_Kwert2 * LS_SALES_INV_HDR-KURRF . " ADDED BY MAHADEV HEMENT ON 10/12/2025
**    LS_FINAL-ASS2_VAL = * wa_vbkd-KURSK
*
*    "" TOTAL assesable value
**     LS_FINAL-TOT_ASS = GV_KBETR * wa_vbkd-KURSK . " ADDED BY MAHADEV HEMENT ON 10/12/2025
*     LS_FINAL-TOT_ASS = GV_KBETR * LS_SALES_INV_HDR-KURRF . " ADDED BY MAHADEV HEMENT ON 10/12/2025
...
*        ls_final-pf_val = ls_conditions-kwert * ls_sales_inv_item-kursk.
    ...
    "Assessable Value
    LS_FINAL-ASS_VAL2 = LS_FINAL-VAL_INR + LS_FINAL-PF_VAL + LS_FINAL-DIS.
    LS_FINAL-ASS_VAL = LS_FINAL-ASS_VAL2.
    "Excise Duty
    READ TABLE LT_CONDITIONS INTO LS_CONDITIONS WITH KEY KNUMV = LS_SALES_INV_HDR-KNUMV
                                                         KPOSN = LS_SALES_INV_ITEM-POSNR
                                                         KSCHL = 'ZEXP'
...
*        LS_FINAL-CGST_P = LS_CONDITIONS-KBETR / 10.
      LS_FINAL-CGST_P = LS_CONDITIONS-KBETR . ""ADDED BY MAHADEV ON 05/06/2025
...
*        LS_FINAL-SGST_P = LS_CONDITIONS-KBETR / 10.
      LS_FINAL-SGST_P = LS_CONDITIONS-KBETR  .   ""ADDED BY MAHADEV ON 05/06/2025
...
*        LS_FINAL-IGST_P = LS_CONDITIONS-KBETR / 10.
      LS_FINAL-IGST_P = LS_CONDITIONS-KBETR . ""ADDED BY MAHADEV ON 05/06/2025
...
*        ls_final-tcs_p = ls_conditions-kbetr / 10.
    ENDIF.
* ****************************added by jyoti on 21.10.2024***************************************
    READ TABLE LT_CONDITIONS INTO LS_CONDITIONS WITH KEY KNUMV = LS_SALES_INV_HDR-KNUMV
                                                         KPOSN = LS_SALES_INV_ITEM-POSNR
                                                         KSCHL = 'JTC1'.
*                                                           kstat = space.
    IF SY-SUBRC IS  INITIAL.
      LS_FINAL-JTC  = LS_CONDITIONS-KWERT * LS_SALES_INV_HDR-KURRF.
*        ls_final-com_cess_v  = ls_conditions-kwert * ls_sales_inv_item-kursk.
*        ls_final-tcs_p = ls_conditions-kbetr / 10.
    ENDIF.
...
*                                                           kstat = space.
    IF SY-SUBRC IS  INITIAL.
      LS_FINAL-JTC  = LS_FINAL-JTC + ( LS_CONDITIONS-KWERT * LS_SALES_INV_HDR-KURRF ).
*        ls_final-com_cess_v  = ls_conditions-kwert * ls_sales_inv_item-kursk.
*        ls_final-tcs_p = ls_conditions-kbetr / 10.
      LS_FINAL-TCS_P = LS_CONDITIONS-KBETR .  ""ADDED BY MAHADEV ON 05/06/2025
    ENDIF.
************************************************************************************************
*      IF NOT ls_final-cgst IS INITIAL OR
*        NOT ls_final-igst IS INITIAL.
    LS_FINAL-ASS_GST2 = LS_FINAL-ASS_VAL + LS_FINAL-FRT + LS_FINAL-INS + LS_FINAL-TES.
    LS_FINAL-ASS_GST = LS_FINAL-ASS_GST2.
*      ENDIF.
    ...
    LS_FINAL-TOT2 =
           ...
           + LS_FINAL-IGST + LS_FINAL-FRT + LS_FINAL-INS + LS_FINAL-TES + LS_FINAL-COM_CESS + LS_FINAL-COM_CESS_V + LS_FINAL-TCS + LS_FINAL-JTC.
    LS_FINAL-TOT = LS_FINAL-TOT2 .
    IF LS_FINAL-FKART = 'ZRE' OR LS_FINAL-FKART = 'ZCR' OR LS_FINAL-FKART = 'ZERO'.   "Added by DH
      LS_FINAL-FKIMG      = LS_FINAL-FKIMG * -1.      "added by DH
...
*        ls_final-sgst       = ls_final-cgst * -1.
      ...
      LS_FINAL-JTC        = LS_FINAL-JTC * -1."ADDED BY JYOTI ON 21.10.2024
...
* Implement suitable error handling here
    ...
    DATA : ZTDLINE TYPE CHAR25.
    ZTDLINE       =  LS_LINES-TDLINE .
...
* Implement suitable error handling here
    ...
    READ TABLE IT_EWAY INTO WA_EWAY WITH KEY VBELN = LS_FINAL-VBELN.
    IF SY-SUBRC = 0.
      LS_FINAL-EWAYNO = WA_EWAY-EWAY_BILL.
      LS_FINAL-EWAYDATE = WA_EWAY-EWAYBILLDATE.

      SELECT EWAY_BILL
             VERSION
             VALIDUPTODATE
             VALIDUPTOTIME FROM ZEWAYEXTEND INTO TABLE IT_EWAYEX
             WHERE EWAY_BILL = WA_EWAY-EWAY_BILL.

      SORT IT_EWAYEX BY VERSION DESCENDING.

      READ TABLE IT_EWAYEX INTO WA_EWAYEX WITH KEY EWAY_BILL = WA_EWAY-EWAY_BILL.
      IF SY-SUBRC = 0.
        LS_FINAL-VALIDUPTODATE = WA_EWAYEX-VALIDUPTODATE.
      ENDIF.

      IF LS_FINAL-VALIDUPTODATE IS INITIAL.
        LS_FINAL-VALIDUPTODATE = WA_EWAY-VALIDUPTODATE.
      ENDIF.

    ENDIF.


    READ TABLE IT_EINV INTO WA_EINV WITH KEY VBELN = LS_FINAL-VBELN.
    IF SY-SUBRC = 0.
*  ls_final-ZZIRN_NO  = wa_einv-ZZIRN_NO.
*  ls_final-ZZQR_CODE = wa_einv-ZZQR_CODE.
      LS_FINAL-ZZCDATE   = WA_EINV-ZZCDATE.
      LS_FINAL-ZZTIME    = WA_EINV-ZZTIME .
    ENDIF.
    IF LS_FINAL-ZZTIME  IS INITIAL.
      LS_FINAL-ZZTIME  = ''.
    ENDIF.

*BREAK PRIMUS.

    SELECT SINGLE IRN SIGNED_QRCODE FROM J_1IG_INVREFNUM INTO ( LS_FINAL-ZZIRN_NO , LS_FINAL-ZZQR_CODE )
      WHERE DOCNO = LS_FINAL-VBELN.

    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""Added by Pranit 22.12.2023 """"DELIVERY BASIS
    LV_ID1 = LS_FINAL-VBELN.
    "Port Code
    CLEAR: LT_LINES1[],LS_LINES1.
    CALL FUNCTION 'READ_TEXT'
      EXPORTING
        CLIENT                  = SY-MANDT
        ID                      = 'Z029'
...
* Implement suitable error handling here
    ENDIF.
    IF NOT LT_LINES1 IS INITIAL.
      LOOP AT LT_LINES1 INTO LS_LINES1.
        IF NOT LS_LINES1-TDLINE IS INITIAL.
          CONCATENATE LS_FINAL-PORT_CD LS_LINES-TDLINE INTO LS_FINAL-PORT_CD SEPARATED BY SPACE.
        ENDIF.
      ENDLOOP.
      CONDENSE LS_FINAL-PORT_CD.
    ...
    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""Added by Pranit 22.12.2023 """INSURANCE POLICY NO.
    LV_ID1 = LS_FINAL-VBELN.
    DATA : ZINSURANCE_PO TYPE CHAR25.
    "Port Code
    CLEAR: LT_LINES2[],LS_LINES2.
    CALL FUNCTION 'READ_TEXT'
      EXPORTING
        CLIENT                  = SY-MANDT
        ID                      = 'Z037'
...
* Implement suitable error handling here
    ...
    IF NOT LT_LINES2 IS INITIAL.
      LOOP AT LT_LINES2 INTO LS_LINES2.
        IF NOT LS_LINES2-TDLINE IS INITIAL.
          CONCATENATE LS_FINAL-PORT_CD LS_LINES-TDLINE INTO LS_FINAL-PORT_CD SEPARATED BY SPACE.
        ENDIF.
      ENDLOOP.
      CONDENSE LS_FINAL-PORT_CD.

      ZINSURANCE_PO = LS_LINES2-TDLINE.
    ...
    WA_FINAL-ZTDLINE       = LS_LINES1-TDLINE .
    WA_FINAL-ZINSURANCE_POL = ZINSURANCE_PO  .
*----------------added by DH
    IF LS_FINAL-FKIMG < 0.
...
************************aDDED BY JYOTI ON 21.10.2024******************************
    IF LS_FINAL-JTC < 0.
      CONDENSE LS_FINAL-JTC.
      CONCATENATE '-' LS_FINAL-JTC INTO LS_FINAL-JTC.
    ENDIF.
*************************************************************************************
...
*BREAK ctpl.
*      WA_FINAL-VTEXT2        = LS_FINAL-VTEXT2.
*    LS_FINAL-DIS_AMT2 = LS_FINAL-DIS_AMT.                           "ADDED BY AAKASHK 17.10.2024
*    IF LS_FINAL-DIS_AMT2 < 0.
*      CONDENSE LS_FINAL-DIS_AMT2.
*      CONCATENATE '-' LS_FINAL-DIS_AMT2 INTO DISAMT.
*      LS_FINAL-DIS_AMT = DISAMT.
*      ELSE.
*        WA_FINAL-DIS_AMT =  LS_FINAL-DIS_AMT.
*    ENDIF.
    WA_FINAL-DIS_AMT =  LS_FINAL-DIS_AMT.
*    WA_FINAL-DIS_AMT       = LS_FINAL-DIS_AMT.                         "ADDED BY mahadev 13/01/2025
    IF LS_FINAL-DIS_RATE < 0.
      DISAMT2 =  LS_FINAL-DIS_RATE * ( -1 ).
      CONCATENATE '-' DISAMT2 INTO WA_FINAL-DIS_RATE .
    ELSE.
...
*gt_final-sal_txt = ls_final-sal_txt.
    ...
    WA_FINAL-EWAYNO = LS_FINAL-EWAYNO.
    WA_FINAL-ZZIRN_NO = LS_FINAL-ZZIRN_NO.
    WA_FINAL-ZZQR_CODE = LS_FINAL-ZZQR_CODE.
*wa_final-ZZCDATE = ls_final-ZZCDATE.
    WA_FINAL-ZZTIME  = LS_FINAL-ZZTIME .
    IF WA_FINAL-ZZTIME IS INITIAL .
      WA_FINAL-ZZTIME = ''.
    ENDIF.
    WA_FINAL-ZTDLINE  = LS_LINES1-TDLINE .
    LS_FINAL-ZTDLINE  = LS_LINES1-TDLINE .
    LS_FINAL-ZINSURANCE_POL = WA_FINAL-ZINSURANCE_POL .
*wa_final-ewaydate = ls_final-ewaydate.
*wa_final-VALIDUPTODATE = ls_final-VALIDUPTODATE.

    IF LS_FINAL-ZZCDATE IS NOT INITIAL .


      CALL FUNCTION 'CONVERSION_EXIT_IDATE_OUTPUT'
        EXPORTING
          INPUT  = LS_FINAL-ZZCDATE
        IMPORTING
          OUTPUT = WA_FINAL-ZZCDATE.
      CONCATENATE WA_FINAL-ZZCDATE+0(2) WA_FINAL-ZZCDATE+2(3) WA_FINAL-ZZCDATE+5(4)
                     INTO WA_FINAL-ZZCDATE SEPARATED BY '-'.
      IF WA_FINAL-ZZCDATE = '--'.
        REPLACE ALL OCCURRENCES OF '--' IN WA_FINAL-ZZCDATE WITH ' '.
      ENDIF.
      LS_FINAL-ZZCDATE = WA_FINAL-ZZCDATE.
    ENDIF.

    IF LS_FINAL-ZZTIME IS NOT INITIAL.
      CONCATENATE LS_FINAL-ZZTIME+0(2) LS_FINAL-ZZTIME+2(2) LS_FINAL-ZZTIME+4(2) INTO WA_FINAL-ZZTIME SEPARATED BY ':'.
    ELSE .
      LS_FINAL-ZZTIME = '0'.
    ENDIF.
    ...
    IF LS_FINAL-EWAYDATE IS NOT INITIAL .


      CALL FUNCTION 'CONVERSION_EXIT_IDATE_OUTPUT'
        EXPORTING
          INPUT  = LS_FINAL-EWAYDATE
        IMPORTING
          OUTPUT = WA_FINAL-EWAYDATE.
      CONCATENATE WA_FINAL-EWAYDATE+0(2) WA_FINAL-EWAYDATE+2(3) WA_FINAL-EWAYDATE+5(4)
                     INTO WA_FINAL-EWAYDATE SEPARATED BY '-'.
      IF WA_FINAL-EWAYDATE = '--'.
        REPLACE ALL OCCURRENCES OF '--' IN WA_FINAL-EWAYDATE WITH ' '.
      ENDIF.
      LS_FINAL-EWAYDATE = WA_FINAL-EWAYDATE.
    ENDIF.

    IF LS_FINAL-VALIDUPTODATE IS NOT INITIAL .


      CALL FUNCTION 'CONVERSION_EXIT_IDATE_OUTPUT'
        EXPORTING
          INPUT  = LS_FINAL-VALIDUPTODATE
        IMPORTING
          OUTPUT = WA_FINAL-VALIDUPTODATE.
      CONCATENATE WA_FINAL-VALIDUPTODATE+0(2) WA_FINAL-VALIDUPTODATE+2(3) WA_FINAL-VALIDUPTODATE+5(4)
                     INTO WA_FINAL-VALIDUPTODATE SEPARATED BY '-'.
      IF WA_FINAL-VALIDUPTODATE = '--'.
        REPLACE ALL OCCURRENCES OF '--' IN WA_FINAL-VALIDUPTODATE WITH ' '.
      ENDIF.
      LS_FINAL-VALIDUPTODATE = WA_FINAL-VALIDUPTODATE.
...
*          WA_FINAL-txt50 = LS_FINAL-TXT50 .  "ADDED BY JYOTI ON 11.06.2024
*
*BREAK primus.
...
*  ENDIF.
  ...
  DELETE CT_FINAL WHERE WERKS NE 'PL01'.

  CALL FUNCTION 'REUSE_ALV_GRID_DISPLAY'
    EXPORTING
      I_CALLBACK_PROGRAM = L_CALLBACK_PROG
*     I_CALLBACK_PF_STATUS_SET          = ' '
*     I_CALLBACK_USER_COMMAND = 'UCOMM_ON_ALV'    "commented by mahadev
...
*  ls_fieldcat-hotspot   = 'X'.
  ...
  GV_POS = GV_POS + 1.
  LS_FIELDCAT-FIELDNAME = 'EWAYNO'.
*  ls_fieldcat-outputlen = '25'.
  LS_FIELDCAT-TABNAME   = 'GT_FINAL'.
  LS_FIELDCAT-SELTEXT_L = 'Eway Bill NO'.
  LS_FIELDCAT-COL_POS   = GV_POS.
*  ls_fieldcat-hotspot   = 'X'.
  APPEND LS_FIELDCAT TO CT_FIELDCAT.
  CLEAR LS_FIELDCAT.
  ...
  GV_POS = GV_POS + 1.
  LS_FIELDCAT-FIELDNAME = 'EWAYDATE'.
*  ls_fieldcat-outputlen = '25'.
  LS_FIELDCAT-TABNAME   = 'GT_FINAL'.
  LS_FIELDCAT-SELTEXT_L = 'Eway Bill Date'.
  LS_FIELDCAT-COL_POS   = GV_POS.
*  ls_fieldcat-hotspot   = 'X'.
  APPEND LS_FIELDCAT TO CT_FIELDCAT.
  CLEAR LS_FIELDCAT.
  ...
  GV_POS = GV_POS + 1.
  LS_FIELDCAT-FIELDNAME = 'VALIDUPTODATE'.
  LS_FIELDCAT-TABNAME   = 'GT_FINAL'.
  LS_FIELDCAT-SELTEXT_L = 'Eway Validity'.
  LS_FIELDCAT-COL_POS   = GV_POS.
  APPEND LS_FIELDCAT TO CT_FIELDCAT.
  CLEAR LS_FIELDCAT.

  GV_POS = GV_POS + 1.
  LS_FIELDCAT-FIELDNAME = 'ZZIRN_NO'.
  LS_FIELDCAT-TABNAME   = 'GT_FINAL'.
  LS_FIELDCAT-SELTEXT_L = 'IRN NO'.
  LS_FIELDCAT-COL_POS   = GV_POS.
  APPEND LS_FIELDCAT TO CT_FIELDCAT.
  CLEAR LS_FIELDCAT.

  GV_POS = GV_POS + 1.
  LS_FIELDCAT-FIELDNAME = 'ZZQR_CODE'.
  LS_FIELDCAT-TABNAME   = 'GT_FINAL'.
  LS_FIELDCAT-SELTEXT_L = 'QR Code'.
  LS_FIELDCAT-COL_POS   = GV_POS.
  APPEND LS_FIELDCAT TO CT_FIELDCAT.
  CLEAR LS_FIELDCAT.

  GV_POS = GV_POS + 1.
  LS_FIELDCAT-FIELDNAME = 'ZZCDATE'.
  LS_FIELDCAT-TABNAME   = 'GT_FINAL'.
  LS_FIELDCAT-SELTEXT_L = 'IRN Creation Date'.
  LS_FIELDCAT-COL_POS   = GV_POS.
  APPEND LS_FIELDCAT TO CT_FIELDCAT.
  CLEAR LS_FIELDCAT.

  GV_POS = GV_POS + 1.
  LS_FIELDCAT-FIELDNAME = 'ZZTIME'.
  LS_FIELDCAT-TABNAME   = 'GT_FINAL'.
  LS_FIELDCAT-SELTEXT_L = 'IRN Creation Time'.
  LS_FIELDCAT-COL_POS   = GV_POS.
  APPEND LS_FIELDCAT TO CT_FIELDCAT.
  CLEAR LS_FIELDCAT.

  GV_POS = GV_POS + 1.
  LS_FIELDCAT-FIELDNAME = 'ZTDLINE'.
  LS_FIELDCAT-TABNAME   = 'GT_FINAL'.
  LS_FIELDCAT-SELTEXT_L = 'Delivery Basis'.
  LS_FIELDCAT-COL_POS   = GV_POS.
  APPEND LS_FIELDCAT TO CT_FIELDCAT.
  CLEAR LS_FIELDCAT.

  GV_POS = GV_POS + 1.
  LS_FIELDCAT-FIELDNAME = 'ZINSURANCE_POL'.
  LS_FIELDCAT-TABNAME   = 'GT_FINAL'.
  LS_FIELDCAT-SELTEXT_L = 'Insurance Policy NO.'.
  LS_FIELDCAT-COL_POS   = GV_POS.
  APPEND LS_FIELDCAT TO CT_FIELDCAT.
  CLEAR LS_FIELDCAT.
...
*******************************************************************************************************************
  ...
  GV_POS = GV_POS + 1.                                                       "added by aakashk 17.10.2024
  LS_FIELDCAT-FIELDNAME = 'JTC'.
  LS_FIELDCAT-TABNAME   = 'GT_FINAL'.
  LS_FIELDCAT-SELTEXT_M = 'TCS Interim'.
  LS_FIELDCAT-COL_POS   = GV_POS.
  APPEND LS_FIELDCAT TO CT_FIELDCAT.
  CLEAR LS_FIELDCAT.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  ...
  OPEN DATASET LV_FULLFILE
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF SY-SUBRC = 0.
    DATA LV_STRING_4128 TYPE STRING.
    DATA LV_CRLF_4128 TYPE STRING.
    LV_CRLF_4128 = CL_ABAP_CHAR_UTILITIES=>CR_LF.
    LV_STRING_4128 = HD_CSV.
    LOOP AT IT_CSV INTO WA_CSV.
      CONCATENATE LV_STRING_4128 LV_CRLF_4128 WA_CSV INTO LV_STRING_4128.
      CLEAR: WA_CSV.
    ENDLOOP.
    TRANSFER LV_STRING_4128 TO LV_FULLFILE.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  ...
  OPEN DATASET LV_FULLFILE
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF SY-SUBRC = 0.
    DATA LV_STRING_4165 TYPE STRING.
    DATA LV_CRLF_4165 TYPE STRING.
    LV_CRLF_4165 = CL_ABAP_CHAR_UTILITIES=>CR_LF.
    LV_STRING_4165 = HD_CSV.
    LOOP AT IT_CSV INTO WA_CSV.
      CONCATENATE LV_STRING_4165 LV_CRLF_4165 WA_CSV INTO LV_STRING_4165.
      CLEAR: WA_CSV.
    ENDLOOP.
    TRANSFER LV_STRING_4165 TO LV_FULLFILE.
    CONCATENATE 'File' LV_FULLFILE 'downloaded' INTO LV_MSG SEPARATED BY SPACE.
    MESSAGE LV_MSG TYPE 'S'.
*  ELSE.
*     lv_file = 'ZSALE.TXT'.
...
*              'ADDL_Data_B_Date'  "sarika talekar
              ...
              'IRN Creation Date'
              'IRN Creation Time'
              'Delivery Basis'          """Added by Pranit 22.12.2023
              'Insurance Policy NO.'    """Added by Pranit 22.12.2023
              'Storage Location'
              'TCS Interim'                "added by aakashk 17.10.2024
