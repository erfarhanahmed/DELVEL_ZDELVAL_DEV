...
* Mehrere Buchungskreise ausgewählt -> keine Arb.vorräte erzeugen.
...
* Summenbericht: Besorge Schlüsselwort "Bezeichnung".
...
* Umrechnungsmethode besorge Schlüsselwort "Währung".
IF UMVAR NE SPACE.
  CALL FUNCTION 'DDIF_FIELDINFO_GET'
       EXPORTING
            TABNAME    = 'T091C'
