...
*&
*&---------------------------------------------------------------------*
REPORT zsu_material_storage_bin_new.
...
DATA : lv_var1 TYPE string VALUE 'ZMB52_PL01',
       lv_var2 TYPE string VALUE 'TPI_FG'.
...
PARAMETERS :    p_werks TYPE mard-werks default 'SU01'.
...
* Implement suitable error handling here
  ...
  IF p_werks = 'PL01' AND sy-slset = lv_var1.
...
*  ENDIF.
  ...
  WRITE: / 'ZSU_MATERIAL STORAGE BIN REPORT started on', sy-datum, 'at', sy-uzeit.
  ...
  ENDIF.
ELSE.
 CONCATENATE 'ZSU_MB52_' S_LGORT '.TXT' INTO LV_FILE.    " ADDED bY nILAY b. o 07.04.2023
