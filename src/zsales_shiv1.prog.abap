...
*&
*&---------------------------------------------------------------------*
REPORT ZSALES_REGISTER_SHIVAJI.
...
"""""""""""""""""""""""""""""""""""""""""""""""added by sp 09.06.2023""""""""""""""""""""""""""""""""""""""""
TYPES : BEGIN OF TY_WB2_V_VBAK_VBAP2,
          VBELN   TYPE WB2_V_VBAK_VBAP2-VBELN,
          POSNR_I TYPE WB2_V_VBAK_VBAP2-POSNR_I,
          KNUMV   TYPE WB2_V_VBAK_VBAP2-KNUMV,
          ERDAT   TYPE WB2_V_VBAK_VBAP2-ERDAT,
        END OF   TY_WB2_V_VBAK_VBAP2.
DATA : WA_WB2_V_VBAK_VBAP2 TYPE TY_WB2_V_VBAK_VBAP2,
       IT_WB2_V_VBAK_VBAP2 TYPE TABLE OF TY_WB2_V_VBAK_VBAP2.
...
*    IGST_P        TYPE prcd_elements-KBETR,              "IGST %
    ...
    REF_TIME      TYPE STRING,            " Added By Nilay B (13.06.2023)
...
*    VBELN   TYPE WB2_V_VBAK_VBAP2-VBELN,           """""""""""""""""""""ADDED BY SP 09.06.2023
    POSNR_I       TYPE WB2_V_VBAK_VBAP2-POSNR_I,
*    KBETR         TYPE STRING, "KONV-KBETR,
    KBETR1        TYPE prcd_elements-KBETR,"P DECIMALS 2,"STRING,                                           """""""""""""""""""""ADDED BY SP 22.06.2023
    KNUMV         TYPE prcd_elements-KNUMV,
    ERDAT         TYPE WB2_V_VBAK_VBAP2-ERDAT,

    EFFECTIVE_RATE TYPE P DECIMALS 2,"CHAR100,                     """""""""""""""""""""""""ADDED BY SP 19.06.2023
...
*    KBETR         TYPE STRING,                  """""""""""""""""""""ADDED BY SP 09.06.2023
    KBETR1        TYPE CHAR100,"P DECIMALS 2,"STRING,                  """""""""""""""""""""ADDED BY SP 22.06.2023

    EFFECTIVE_RATE TYPE CHAR100,"P DECIMALS 2,"CHAR100,
...
PARAMETERS : p_werks TYPE vbrp-werks DEFAULT 'PL01' .
               .
  ...
  IF NOT SO_ORD IS INITIAL.
    ...
    IF LT_SALES_INV_ITEM IS NOT INITIAL.
      SELECT VBELN
        ...
        AND   POSNR_I = LT_SALES_INV_ITEM-AUPOS
        AND   ERDAT  IN SO_FKDAT. "Lt_SALES_INV_ITEM-FKDAT.

    ENDIF.

    IF IT_WB2_V_VBAK_VBAP2 IS NOT INITIAL.
      SELECT KNUMV
             KPOSN
             KSCHL
             KBETR
        ...
        INTO TABLE IT_KONV
        FOR ALL ENTRIES IN IT_WB2_V_VBAK_VBAP2
        WHERE KNUMV = IT_WB2_V_VBAK_VBAP2-KNUMV
        AND   KPOSN = IT_WB2_V_VBAK_VBAP2-POSNR_I
        AND   KSCHL = 'ZPR0'.
    ENDIF.
...
***  DELETE lt_sales_inv_hdr WHERE fkart = 'ZS1'. " Cancel Invoice Skip
  ...
  IF NOT LT_SALES_INV_HDR IS INITIAL.
    ...
    FOR ALL ENTRIES IN LT_SALES_INV_HDR
    WHERE VBELN = LT_SALES_INV_HDR-VBELN
    AND   WERKS = P_WERKS.                                  """"""""""""""""""""""""ADDED BY SP 19.06.2023
...
*      ls_final-aupos = ls_sales_inv_item-aupos.
      ...
      ls_final-kursk = ls_sales_inv_item-kursk.                    """"""""""""""""""""""ADDED BY SP 20.06.2023
...
*        ls_final-tcs_p = ls_conditions-kbetr / 10.
      ...
      READ TABLE IT_WB2_V_VBAK_VBAP2 INTO WA_WB2_V_VBAK_VBAP2 WITH KEY VBELN   = LS_FINAL-AUBEL
                                                                       POSNR_I = LS_FINAL-POSNR.

*      LS_FINAL-VBELN   = WA_WB2_V_VBAK_VBAP2-VBELN.
      LS_FINAL-POSNR_I = WA_WB2_V_VBAK_VBAP2-POSNR_I.
      LS_FINAL-KNUMV   = WA_WB2_V_VBAK_VBAP2-KNUMV.

      READ TABLE LT_CONDITIONS INTO LS_CONDITIONS WITH KEY KNUMV = LS_SALES_INV_HDR-KNUMV
                                                             KPOSN = LS_SALES_INV_ITEM-POSNR
                                                             KSCHL = 'ZPR0'.
*      LS_FINAL-KBETR  = LS_CONDITIONS-KBETR.

      "*****************************ADDED BY SP 22.06.2023*********************************


      LS_FINAL-KBETR1 = LS_CONDITIONS-KBETR + (  LS_FINAL-PF_VAL /  LS_FINAL-FKIMG ) .
*       DATA : l_amt TYPE char16.
*
*l_amt = LS_FINAL-KBETR1. "amount is number field
*
...
*      ENDIF.
      ...
      LS_FINAL-EFFECTIVE_RATE = LS_FINAL-ASS_VAL /  LS_FINAL-FKIMG.    "******************************ADDED BY SP 19.06.2023

      """""""""""""""""""""""""ADDED BY SP 20.06.2023""""""""""""""""""""""""""""""""""""""""""""""""""
      IF ls_final-WAERK = 'USD' OR ls_final-WAERK ='EUR' OR ls_final-WAERK ='GBP'.
      LS_FINAL-EFFECTIVE_RATE = LS_FINAL-EFFECTIVE_RATE / ls_final-kursk.
      ENDIF.
      """""""""""""""""""""""""ADDED BY SP 20.06.2023""""""""""""""""""""""""""""""""""""""""""""""""""
...
* Implement suitable error handling here
      ...
      WA_FINAL-KBETR1          = LS_FINAL-KBETR1.                             """"""""""""""""""ADDED BY SP 09.06.2023"""""""""""""
      WA_FINAL-EFFECTIVE_RATE = LS_FINAL-EFFECTIVE_RATE.                    """"""""""""""""""ADDED BY SP 19.06.2023"""""""""""""
...
*  ls_fieldcat-outputlen = '10'.
  LS_FIELDCAT-TABNAME   = 'GT_FINAL'.
  LS_FIELDCAT-SELTEXT_M = 'EFFECTIVE SO RATE/EA'.
  LS_FIELDCAT-COL_POS   = GV_POS.
*  ls_fieldcat-hotspot   = 'X'.
  APPEND LS_FIELDCAT TO CT_FIELDCAT.
  CLEAR LS_FIELDCAT.
  ...
  """"""""""""""""""""""""""""""""""""""""""""""""ADDED BY 19.06.2023
  GV_POS = GV_POS + 1.
  LS_FIELDCAT-FIELDNAME = 'EFFECTIVE_RATE'.
*  ls_fieldcat-outputlen = '10'.
  LS_FIELDCAT-TABNAME   = 'GT_FINAL'.
  LS_FIELDCAT-SELTEXT_M = 'EFFECTIVE RATE'.
  LS_FIELDCAT-COL_POS   = GV_POS.
*  ls_fieldcat-hotspot   = 'X'.
  APPEND LS_FIELDCAT TO CT_FIELDCAT.
  CLEAR LS_FIELDCAT.
...
*              'ADDL_Data_B_Date'  "sarika talekar
              ...
              'Refreshable Time'    " By Nilay B (13.06.2023)
              'TCS Rate'
              'TCS Amount'
              'Effective SO RATE/EA'              """"""""""""""""ADDED BY SP 09.06.2023

              'Effective Rate'            """"""""""""""""ADDED BY SP 19.06.2023
  INTO PD_CSV
